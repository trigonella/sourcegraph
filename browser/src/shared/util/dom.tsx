 ...
 */
export function commitIDFromPermalink({
  selector,
  hrefRegex
}: {
  selector: string;
...
export function querySelectorAllOrSelf(
  element: Element,
  selectors: string
...
export function querySelectorOrSelf<E extends Element = Element>(
  element: Element,
  selectors: string
): E | null;
export function querySelectorOrSelf(
  element: Element,
  selectors: string
): Element | null {
  return element.matches(selectors)
