...
export class ServerUrlForm extends React.Component<ServerUrlFormProps> {
  ...
  public render(): React.ReactNode {
    return (
      ...
      <form
        className={`server-url-form ${this.props.className || ""}`}
              ...
              <span>
                <span
                  className={
                    ...
                    (this.isUpdating
                      ? "secondary"
                      : statusClassNames[this.props.status])
                  }
                />{" "}
                <span className="test-connection-status">
                  {this.isUpdating
                    ? zeroWidthNbsp
                    : upperFirst(this.props.status)}
                </span>
              </span>
            </span>
          </div>
              ...
              {!this.props.urlHasPermissions && (
                <p>
                  ...
                  <a href="#" onClick={this.requestServerURLPermissions}>
                    grant the Sourcegraph browser extension additional
                    permissions
                  </a>{" "}
                  for this URL.
                </p>
  ...
  private requestServerURLPermissions = (): void =>
    this.props.requestPermissions(this.props.value);
