...
shelljs.exec(
  "git clone git@github.com:sourcegraph/code-intel-extensions || (cd code-intel-extensions; git pull)"
);
shelljs.exec("yarn --cwd code-intel-extensions install");
shelljs.exec(
  `yarn --cwd code-intel-extensions/extensions/${extensionName} run build`
);
shelljs.popd();
