...
ALTER TABLE repo_pending_permissions ADD COLUMN user_ids BYTEA NOT NULL DEFAULT '\x3a30000000000000';
ALTER TABLE user_pending_permissions ADD COLUMN object_ids BYTEA NOT NULL DEFAULT '\x3a30000000000000';
