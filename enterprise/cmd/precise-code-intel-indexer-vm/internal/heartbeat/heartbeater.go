...
func NewHeartbeater(ctx context.Context, queueClient queue.Client, indexManager *indexmanager.Manager, options HeartbeaterOptions) goroutine.BackgroundRoutine {
