...
declare module "sourcegraph" {
  ...
  export interface DecorationAttachmentRenderOptions
    extends ThemableDecorationAttachmentStyle {
  ...
  export interface CodeEditor {
     ...
     */
    setDecorations(
      decorationType: TextDocumentDecorationType,
  ...
  export type ChartContent =
    | LineChartContent<any, string>
    | BarChartContent<any, string>
    | PieChartContent<any>;
  ...
  export interface BadgeAttachmentRenderOptions
    extends ThemableBadgeAttachmentStyle {
  ...
  export namespace commands {
     ...
     */
    export function executeCommand<T = any>(
      command: string,
      ...args: any[]
    ): Promise<T>;
  }
