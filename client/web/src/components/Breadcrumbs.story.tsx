...
add(
            ...
            },
            {
              ...
              breadcrumb: {
                ...
                element: (
                  <a href="#">
                    sourcegraph/
                    <span className="font-weight-semibold">sourcegraph</span>
                  </a>
                )
              }
            },
  ...
  ),
  {
    design: {
      type: "figma",
      url:
        "https://www.figma.com/file/BkY8Ak997QauG0Iu2EqArv/Sourcegraph-Components?node-id=230%3A83"
    }
  }
);
