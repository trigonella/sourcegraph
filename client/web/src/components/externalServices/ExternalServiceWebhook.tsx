...
export const ExternalServiceWebhook: React.FunctionComponent<Props> = ({
    ...
    case ExternalServiceKind.BITBUCKETSERVER:
      description = (
        <p>
          ...
          will be created automatically on the configured Bitbucket Server
          instance. In case you don't provide an admin token,{" "}
          <a
  ...
  return (
    <div className="alert alert-info">
      ...
      <p className="mb-0">
        ...
        make use of this webhook. To enable webhooks to trigger repository
        updates on Sourcegraph,{" "}
        <a
