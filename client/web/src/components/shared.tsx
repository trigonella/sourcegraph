...
import {
  ActionsNavItems,
  ActionsNavItemsProps
} from "../../../shared/src/actions/ActionsNavItems";
import {
...
export const WebHoverOverlay: React.FunctionComponent<HoverOverlayProps &
  HoverThresholdProps> = props => {
  const [dismissedAlerts, setDismissedAlerts] = useLocalStorage<string[]>(
    "WebHoverOverlay.dismissedAlerts",
    []
  );
  ...
  if (
    ...
    propsToUse = {
      ...props,
      hoverOrError: { ...props.hoverOrError, alerts: filteredAlerts }
    };
  }
...
const completionWidgetListItemClassName =
  "completion-widget-dropdown__item d-flex align-items-center p-2";
