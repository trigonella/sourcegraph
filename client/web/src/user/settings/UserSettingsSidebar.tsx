    ...
    <div className={`user-settings-sidebar ${props.className || ""}`}>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupItems>
            {props.user.organizations.nodes.map(org => (
              ...
              >
                <OrgAvatar org={org.name} className="d-inline-flex" />{" "}
                {org.name}
              </SidebarNavItem>
            ))}
          </SidebarGroupItems>
      ...
      {props.authenticatedUser.siteAdmin && (
        <Link to="/site-admin" className={SIDEBAR_BUTTON_CLASS}>
          <ServerIcon className="icon-inline list-group-item-action-icon" />{" "}
          Site admin
        </Link>
      )}
      {props.showOnboardingTour && (
        ...
        >
          <MapSearchOutlineIcon className="icon-inline list-group-item-action-icon" />{" "}
          Show search tour
        </button>
      )}
      {!siteAdminViewingOtherUser &&
        ...
        props.authenticatedUser.session.canSignOut && (
          ...
          >
            <LogoutIcon className="icon-inline list-group-item-action-icon" />{" "}
            Sign out
          </a>
        )}
