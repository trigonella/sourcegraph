...
export class UserSettingsPasswordPage extends React.Component<Props, State> {
  ...
  private setNewPasswordConfirmationField = (
      ...
      <div className="user-settings-password-page">
        ...
        {this.props.authenticatedUser.id !== this.props.user.id ? (
          <div className="alert alert-danger">
            ...
            <Link
              to={`/site-admin/users?query=${encodeURIComponent(
          ...
          <>
            ...
            {this.state.saved && (
              <div className="alert alert-success mb-3">Password changed!</div>
            )}
  ...
  private onOldPasswordFieldChange = (
    event: React.ChangeEvent<HTMLInputElement>
  ): void => {
    this.setState({ oldPassword: event.target.value });
  };

  private onNewPasswordFieldChange = (
    event: React.ChangeEvent<HTMLInputElement>
  ): void => {
  ...
  private onNewPasswordConfirmationFieldChange = (
    event: React.ChangeEvent<HTMLInputElement>
  ): void => {
