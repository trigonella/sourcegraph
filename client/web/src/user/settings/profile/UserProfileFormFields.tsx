...
export type UserProfileFormFieldsValue = Pick<
  GQL.IUser,
...
export const UserProfileFormFields: React.FunctionComponent<Props> = ({
  ...
  const onAvatarURLChange = useCallback<
    React.ChangeEventHandler<HTMLInputElement>
  ...
  return (
    <div className="user-profile-form-fields">
      <div className="form-group">
        ...
        >
          A username consists of letters, numbers, hyphens (-), dots (.) and may
          not begin or end with a dot, nor begin with a hyphen.
        </small>
      </div>
      <div className="form-group">
