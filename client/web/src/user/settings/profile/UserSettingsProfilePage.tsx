...
interface Props
  extends Pick<UserAreaRouteContext, "onUserUpdate" | "activation"> {
...
export const UserSettingsProfilePage: React.FunctionComponent<Props> = ({
  ...
  const onUpdate = useCallback<
    React.ComponentProps<typeof EditUserProfileForm>["onUpdate"]
  >(
    newValue => {
  ...
  return (
    <div className="user-settings-profile-page">
      ...
      {props.activation?.completed &&
        percentageDone(props.activation.completed) < 100 && (
