    ...
    return (
      <div className="site-admin-create-user-page">
        ...
        <p className="mb-4">
          ...
          <Link to="/help/admin/auth">User authentication</Link> in the
        ...
        {this.state.createUserResult ? (
          <div className="alert alert-success">
            ...
            {this.state.createUserResult.resetPasswordURL !== null ? (
              <>
                <p>
                  You must manually send this password reset link to the new
                  user:
                </p>
                <CopyableText
                  text={this.state.createUserResult.resetPasswordURL}
                  size={40}
                />
              </>
            ) : (
              <p>
                The user must authenticate using a configured authentication
                provider.
              </p>
            )}
            <button
          ...
          <Form
            ...
            className="site-admin-create-user-page__form"
          >
            <div className="form-group site-admin-create-user-page__form-group">
              <label htmlFor="site-admin-create-user-page__form-username">
                Username
              </label>
              <UsernameInput
            ...
            <div className="form-group site-admin-create-user-page__form-group">
              <label htmlFor="site-admin-create-user-page__form-email">
                Email
              </label>
              <EmailInput
              ...
              />
              <small
                id="site-admin-create-user-page__form-email-help"
