...
const RepositoryNode: React.FunctionComponent<RepositoryNodeProps> = ({
  node
}) => (
  <li
 ...
 */
export const SiteAdminRepositoriesPage: React.FunctionComponent<Props> = ({
  history,
  location,
  telemetryService
}) => {
  ...
  const showRepositoriesAddedBanner = new URLSearchParams(location.search).has(
    "repositoriesUpdated"
  );
    ...
    <div className="site-admin-repositories-page">
      ...
      {showRepositoriesAddedBanner && (
        <p className="alert alert-success">
          Updating repositories. It may take a few moments to clone and index
          each repository. Repository statuses are displayed below.
        </p>
      )}
      <h2>Repositories</h2>
      <p>
