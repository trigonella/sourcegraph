...
export const SiteAdminPingsPage: React.FunctionComponent<Props> = props => {
  const latestPing = useObservable(
    useMemo(
      () =>
        fromFetch<{}>("/site-admin/pings/latest", {
  ...
  return (
    <div className="site-admin-pings-page">
      ...
      <p>
        ...
        product and customer teams. It sends only the high-level data below. It
        never sends code, repository names, usernames, or any other specific
        data.
      </p>
      ...
      <p>
        Critical telemetry includes only the high-level data below required for
        billing, support, updates, and security notices. This cannot be
        disabled.
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>
          Which category of authentication provider is in use (built-in, OpenID
          Connect, an HTTP proxy, SAML, GitHub, GitLab)
        </li>
        <li>
        ...
        <li>
          Aggregate daily, weekly, and monthly latencies (in ms) of search
          queries
        </li>
        <li>
          ...
          <ul>
            ...
            <li>
              Searches using each search filter (e.g. "type:", "repo:", "file:",
              "lang:", etc.)
            </li>
          </ul>
        </li>
