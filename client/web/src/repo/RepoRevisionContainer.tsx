  ...
  const breadcrumbSetters = useBreadcrumb(
    useMemo(() => {
      if (
        ...
        isErrorLike(props.resolvedRevisionOrError)
      ) {
        return;
      }
        ...
        element: (
          <div className="d-flex align-items-center" key="repo-revision">
            <span className="test-revision">
              {(props.revision &&
              props.revision === props.resolvedRevisionOrError.commitID
  ...
  if (isErrorLike(props.resolvedRevisionOrError)) {
    ...
    if (isCloneInProgressErrorLike(props.resolvedRevisionOrError)) {
      return (
        <RepositoryCloningInProgressPage
          repoName={props.repo.name}
          progress={
            (props.resolvedRevisionOrError as CloneInProgressError).progress
          }
        />
      );
    }
    ...
    return (
      <HeroPage
        ...
        subtitle={
          <ErrorMessage
            error={props.resolvedRevisionOrError}
            history={props.history}
          />
        }
      />
  ...
  return (
    <div className="repo-revision-container">
      ...
      <RepoHeaderContributionPortal
        ...
        repoHeaderContributionsLifecycleProps={
          props.repoHeaderContributionsLifecycleProps
        }
      />
      <RepoHeaderContributionPortal
        position="right"
