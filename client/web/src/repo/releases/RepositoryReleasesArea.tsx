...
interface Props
  extends RouteComponentProps<{}>,
    Pick<
      ...
      "repo" | "routePrefix" | "repoHeaderContributionsLifecycleProps"
    >,
    BreadcrumbSetters {
 ...
 */
export const RepositoryReleasesArea: React.FunctionComponent<Props> = ({
  useBreadcrumb,
  repo,
  routePrefix
}) => {
  useBreadcrumb(
    useMemo(
      () => ({
        key: "tags",
        element: (
          <RepoHeaderBreadcrumbNavItem key="tags">
            Tags
