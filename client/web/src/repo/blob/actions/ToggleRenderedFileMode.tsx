...
export class ToggleRenderedFileMode extends React.PureComponent<Props> {
  ...
  public static getModeFromURL(location: H.Location): RenderMode {
    ...
    return searchParameters.get(ToggleRenderedFileMode.URL_QUERY_PARAM) ===
      "code"
      ? "code"
      : "rendered"; // default to rendered
  }
  ...
  public render(): JSX.Element | null {
    const otherMode: RenderMode =
      this.props.mode === "code" ? "rendered" : "code";

    return (
      <ButtonLink
        to={this.getURLForMode(this.props.location, otherMode)}
        data-tooltip={
          otherMode === "code" ? "Show raw code file" : "Show formatted file"
        }
      >
