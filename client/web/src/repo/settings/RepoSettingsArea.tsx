...
export interface RepoSettingsAreaRoute
  extends RouteDescriptor<RepoSettingsAreaRouteContext> {}
  ...
  if (isErrorLike(repoOrError)) {
    return (
      <HeroPage
        ...
        title="Error"
        subtitle={
          <ErrorMessage error={repoOrError.message} history={props.history} />
        }
      />
    );
  }
