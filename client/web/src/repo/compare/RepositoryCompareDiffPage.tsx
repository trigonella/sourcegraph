...
export class RepositoryCompareDiffPage extends React.PureComponent<
  RepositoryCompareDiffPageProps
> {
        ...
        <FileDiffConnection
          ...
          nodeComponentProps={{
            ...
            extensionInfo: {
              base: {
                ...this.props.base,
                revision: this.props.base.revision || "HEAD"
              },
              head: {
                ...this.props.head,
                revision: this.props.head.revision || "HEAD"
              },
