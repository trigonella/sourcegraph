...
import {
  createInvalidGraphQLQueryResponseError,
  dataOrThrowErrors,
  gql
...
const CommitNode: React.FunctionComponent<CommitNodeProps> = ({
  node,
  location
}) => (
...
export class RepoRevisionSidebarCommits extends React.PureComponent<Props> {
  ...
  private fetchCommits = (args: {
    query?: string;
  }): Observable<CommitAncestorsConnectionFields> =>
    fetchCommits(this.props.repoID, this.props.revision || "", {
      ...args,
      currentPath: this.props.filePath || ""
    });
}
