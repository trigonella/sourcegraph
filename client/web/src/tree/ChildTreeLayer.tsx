...
interface ChildTreeLayerProps
  extends Pick<TreeRootProps, Exclude<keyof TreeRootProps, "sizeKey">> {
 ...
 */
export const ChildTreeLayer: React.FunctionComponent<ChildTreeLayerProps> = (
            ...
            <td>
              {hasSingleChild(props.entries) ? (
                <SingleChildTreeLayer
                  ...
                  index={0}
                  isExpanded={props.expandedTrees.includes(
                    props.singleChildTreeEntry.path
                  )}
