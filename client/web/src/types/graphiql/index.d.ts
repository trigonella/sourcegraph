...
import * as React from 'react'
  ...
  export default class GraphiQL extends React.Component<Props> {
    public static Logo: React.ComponentClass<any>public static Toolbar:
        React.ComponentClass<any>public static Button:
            React.ComponentClass<any>public static Menu:
                React.ComponentClass<any>public static MenuItem:
                    React.ComponentClass<any>public static Select: React
                        .ComponentClass<any>public static SelectOption:
                            React.ComponentClass<any>public static Group: React
                        .ComponentClass<any>public static Footer:
        ...
        // the history pane.
        public handlePrettifyQuery:
            () => void public handleToggleHistory: () => void
  }
}
