...
const { add } = storiesOf(
  "web/VersionContextDropdown",
  module
).addDecorator(story => <WebStory>{webProps => story()}</WebStory>);
  ...
  availableVersionContexts: [
    {
      name: "test 1",
      description: "test 1",
      revisions: [{ rev: "test", repo: "github.com/test/test" }]
    },
    {
      name: "test 2",
      description: "test 2",
...
add(
  "No context selected",
  () => <VersionContextDropdown {...commonProps} versionContext={undefined} />,
  {
    design: {
      type: "figma",
      url:
        "https://www.figma.com/file/Sax8ctk8GhvWd0vrzkHSDK/Version-Contexts?node-id=97%3A175"
    }
  }
);
add(
  "Context selected",
  () => <VersionContextDropdown {...commonProps} versionContext="test 1" />,
  {
    design: {
      type: "figma",
      url:
        "https://www.figma.com/file/Sax8ctk8GhvWd0vrzkHSDK/Version-Contexts?node-id=95%3A22516"
    }
  }
);
