...
jest.mock("../search/input/SearchNavbarItem", () => ({
  SearchNavbarItem: "SearchNavbarItem"
}));
jest.mock("../components/branding/BrandLogo", () => ({
  BrandLogo: "BrandLogo"
}));
...
describe("GlobalNavbar", () => {
  ...
  test("default", () =>
    expect(
      renderer.create(<GlobalNavbar {...PROPS} />).toJSON()
    ).toMatchSnapshot());

  test("low-profile", () =>
    expect(
      renderer
        .create(<GlobalNavbar {...PROPS} variant="low-profile" />)
        .toJSON()
    ).toMatchSnapshot());
  ...
  test("no-search-input", () =>
    expect(
      renderer
        .create(<GlobalNavbar {...PROPS} variant="no-search-input" />)
        .toJSON()
    ).toMatchSnapshot());
});
