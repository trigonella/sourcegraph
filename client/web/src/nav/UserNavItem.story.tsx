...
add(
    ...
    <WebStory>
      {webProps => (
        <UserNavItem
          ...
          themePreference={
            webProps.isLightTheme ? ThemePreference.Light : ThemePreference.Dark
          }
  ...
  ),
  {
    design: {
      type: "figma",
      url:
        "https://www.figma.com/file/HWLuLefEdev5KYtoEGHjFj/Sourcegraph-Components-Contractor?node-id=1346%3A0"
    }
  }
);
