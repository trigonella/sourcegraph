  ...
  public render(): JSX.Element | null {
    return (
      this.props.authenticatedUser && (
        <Dialog
          className="saved-search-modal-form "
            ...
            <div className="form-group">
              ...
              >
                ...
                {this.props.authenticatedUser.organizations &&
                  this.props.authenticatedUser.organizations.nodes.length >
                    0 && <option value={UserOrOrg.Org}>Organization</option>}
              </select>
              {this.props.authenticatedUser.organizations &&
                ...
                this.state.saveLocation === UserOrOrg.Org && (
                  ...
                  >
                    ...
                    {this.props.authenticatedUser.organizations.nodes.map(
                      org => (
      ...
      this.props.history.push(
        this.state.saveLocation.toLowerCase() === "user"
          ...
          : `/organizations/${this.state
              .organization!}/searches/add?query=${encodedQuery}&patternType=${
