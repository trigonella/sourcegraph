    ...
    return (
      <div>
        ...
        {this.props.authenticatedUser && savedSearch && (
          ...
          <SavedSearchForm
            ...
            onSubmit={(
              fields: Pick<
                SavedQueryFields,
                Exclude<keyof SavedQueryFields, "id">
              >
            ): void => this.onSubmit({ id: savedSearch.id, ...fields })}
            error={
              isErrorLike(this.state.updatedOrError)
                ? this.state.updatedOrError
                : undefined
            }
          />
        ...
        {this.state.updatedOrError === true && (
          <p className="alert alert-success user-settings-profile-page__alert">
            Updated!
          </p>
        )}
      </div>
