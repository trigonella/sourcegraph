...
const dateTickFormatter = (timestamp: number): string =>
  dateTickFormat.format(timestamp);
...
const tooltipLabelFormatter = (date: number): string =>
  tooltipLabelFormat.format(date);
      ...
      <div className="col-md-8 offset-md-2 col-sm-12 card mt-5">
        <div className="card-body p-5">
          <h2 className="text-center mb-4">
            The burndown chart requires 2 days of data
          </h2>
          <p>
            Come back in a few days and we'll be able to show you data on how
