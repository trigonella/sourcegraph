  ...
  <div className="container web-content mt-3">
    ...
    <div className="row">
      <section className="my-3 col-md-8 col-xs-12">
        <h2>Get started</h2>
        <p>
          <strong>Campaigns are not available on Sourcegraph.com</strong>.
          Instead, use a private Sourcegraph instance to try them on your code.
        </p>
        <ol>
          <li>
          ...
          <li>
            <a href="https://docs.sourcegraph.com/admin/repo/add">
              Add repositories
            </a>{" "}
            from your code host to Sourcegraph.
          </li>
          <li>
            Follow the{" "}
            <a
        ...
        <section className="my-3">
          ...
          <p>
            ...
            <a href="https://twitter.com/srcgraph">@srcgraph</a>, file an issue
            in our{" "}
            <a href="https://github.com/sourcegraph/sourcegraph/issues">
              public issue tracker
            </a>
            , or email{" "}
            <a href="mailto:feedback@sourcegraph.com">
