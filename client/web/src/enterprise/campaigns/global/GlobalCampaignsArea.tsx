...
import {
  UserCampaignListPageProps,
  CampaignListPageProps,
  OrgCampaignListPageProps
} from "../list/CampaignListPage";
...
const CampaignListPage = lazyComponent<
  CampaignListPageProps,
  "CampaignListPage"
>(() => import("../list/CampaignListPage"), "CampaignListPage");
const OrgCampaignListPage = lazyComponent<
  OrgCampaignListPageProps,
  "OrgCampaignListPage"
>(() => import("../list/CampaignListPage"), "OrgCampaignListPage");
const UserCampaignListPage = lazyComponent<
  UserCampaignListPageProps,
  "UserCampaignListPage"
>(() => import("../list/CampaignListPage"), "UserCampaignListPage");
const CampaignApplyPage = lazyComponent<
  CampaignApplyPageProps,
  "CampaignApplyPage"
>(() => import("../apply/CampaignApplyPage"), "CampaignApplyPage");
const CreateCampaignPage = lazyComponent<
  CreateCampaignPageProps,
  "CreateCampaignPage"
>(() => import("../create/CreateCampaignPage"), "CreateCampaignPage");
const CampaignDetailsPage = lazyComponent<
  CampaignDetailsPageProps,
  "CampaignDetailsPage"
>(() => import("../detail/CampaignDetailsPage"), "CampaignDetailsPage");
const CampaignClosePage = lazyComponent<
  CampaignClosePageProps,
  "CampaignClosePage"
>(() => import("../close/CampaignClosePage"), "CampaignClosePage");
const CampaignsDotComPage = lazyComponent<
  CampaignsDotComPageProps,
  "CampaignsDotComPage"
>(() => import("./marketing/CampaignsDotComPage"), "CampaignsDotComPage");
...
export const AuthenticatedCampaignsArea = withAuthenticatedUser<
  AuthenticatedProps
>(({ match, ...outerProps }) => {
  ...
  return (
    <div className="w-100">
      <Breadcrumbs
        breadcrumbs={outerProps.breadcrumbs}
        location={outerProps.location}
      />
        ...
        <Switch>
          ...
          <Route
            ...
            render={({
              match,
              ...props
            }: RouteComponentProps<{ campaignName: string }>) => (
              <CampaignClosePage
                {...outerProps}
                {...props}
                {...breadcrumbSetters}
...
export const OrgCampaignsArea = withAuthenticatedUser<
  OrgCampaignsAreaProps & { authenticatedUser: AuthenticatedUser }
