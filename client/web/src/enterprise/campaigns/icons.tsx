 ...
 */
const BaseCampaignsIcon: React.FunctionComponent<{
  className?: string;
  viewBox?: string;
}> = React.memo(function BaseCampaignsIcon({
  className = "",
  viewBox = "0 0 20 20"
}) {
  return (
 ...
 */
export const CampaignsIcon: React.FunctionComponent<{ className?: string }> = ({
  className
 ...
 * below it.
 */
export const CampaignsIconFlushLeft: React.FunctionComponent<{
  className?: string;
}> = ({ className }) => (
