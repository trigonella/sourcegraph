...
export const CampaignNode: React.FunctionComponent<CampaignNodeProps> = ({
  ...
  <>
    ...
    {!node.closedAt && (
      <span className="campaign-node__badge badge badge-success text-uppercase">
        Open
      </span>
    )}
    {node.closedAt && (
      <span className="campaign-node__badge badge badge-danger text-uppercase">
        Closed
      </span>
    )}
    <div className="campaign-node__content">
      ...
      <Markdown
        className={classNames(
          "text-truncate d-none d-md-block",
    ...
    <ChangesetStatusOpen
      ...
      label={
        <span className="text-muted">{node.changesets.stats.open} open</span>
      }
    />
    <ChangesetStatusClosed
      ...
      label={
        <span className="text-muted">
          {node.changesets.stats.closed} closed
        </span>
      }
    />
    <ChangesetStatusMerged
      ...
      label={
        <span className="text-muted">
          {node.changesets.stats.merged} merged
        </span>
      }
    />
  </>
