 ...
 */
export const UserCampaignListPage: React.FunctionComponent<UserCampaignListPageProps> = ({
  userID,
  ...props
}) => {
  ...
  return (
    <CampaignListPage
      ...
      queryCampaigns={queryConnection}
    />
  );
};
 ...
 */
export const OrgCampaignListPage: React.FunctionComponent<OrgCampaignListPageProps> = ({
  orgID,
  ...props
}) => {
  const queryConnection = useCallback(
