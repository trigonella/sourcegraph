...
const queryChangesetSpecs = (): Observable<(CampaignSpecChangesetSpecsResult["node"] & {
...
const queryEmptyChangesetSpecs = (): Observable<(CampaignSpecChangesetSpecsResult["node"] & {
  __typename: "CampaignSpec";
})["changesetSpecs"]> =>
  of({
    pageInfo: {
