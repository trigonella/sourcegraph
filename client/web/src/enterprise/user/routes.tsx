...
const UserCampaignsArea = lazyComponent<
  UserCampaignsAreaProps,
  "UserCampaignsArea"
>(() => import("../campaigns/global/GlobalCampaignsArea"), "UserCampaignsArea");
...
export const enterpriseUserAreaRoutes: readonly UserAreaRoute[] = [
  ...
  // Redirect from previous /users/:username/subscriptions -> /users/:username/settings/subscriptions.
  {
    ...
    render: (
      props: UserAreaRouteContext & RouteComponentProps<{ page: string }>
    ) => (
      <Redirect
  ...
  },
  {
    ...
    condition: props =>
      !props.isSourcegraphDotCom && window.context.campaignsEnabled
  }
];
