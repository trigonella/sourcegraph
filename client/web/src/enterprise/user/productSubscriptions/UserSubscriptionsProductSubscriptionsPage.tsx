...
export const UserSubscriptionsProductSubscriptionsPage: React.FunctionComponent<Props> = props => {
      ...
      return queryGraphQL(
        ...
        map(({ data, errors }) => {
          if (
            !data ||
            !data.dotcom ||
            !data.dotcom.productSubscriptions ||
  ...
  return (
    <div className="user-subscriptions-product-subscriptions-page">
      ...
      <p>
        A subscription gives you a license key to run a self-hosted Sourcegraph
        instance. See{" "}
        <a href="https://about.sourcegraph.com/pricing">Sourcegraph pricing</a>{" "}
