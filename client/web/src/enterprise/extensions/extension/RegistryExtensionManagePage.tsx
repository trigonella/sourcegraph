...
function updateExtension(
  args: Pick<
    ...
    Exclude<
      keyof GQL.IUpdateExtensionOnExtensionRegistryMutationArguments,
      "manifest"
    >
  >
...
interface State {
  ...
  updateOrError?:
    | "loading"
    | GQL.IExtensionRegistryUpdateExtensionResult
    | ErrorLike;
}
              ...
              concat(
                ...
                updateExtension({
                  ...
                  tap(result => {
                    ...
                    if (
                      this.props.extension.registryExtension!.url !==
                      result.extension.url
                    ) {
                      this.props.history.push(
                        result.extension.url + "/-/manage"
                      );
                    }
    ...
    public render(): JSX.Element | null {
      ...
      const extensionName =
        this.state.name === undefined
          ? this.props.extension.registryExtension.name
          : this.state.name;
