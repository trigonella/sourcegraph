...
jest.mock("./SiteAdminProductLicenseNode", () => ({
  SiteAdminProductLicenseNode: "SiteAdminProductLicenseNode"
}));

jest.mock("../../../dotcom/productSubscriptions/AccountName", () => ({
