        ...
        .pipe(
          switchMap(() =>
            deleteRegistryExtensionWithConfirmation(this.props.node.id).pipe(
              ...
              startWith<
                Pick<RegistryExtensionNodeSiteAdminState, "deletionOrError">
              >({
...
export class SiteAdminRegistryExtensionsPage extends React.PureComponent<
  Props
> {
  ...
  public render(): JSX.Element | null {
    ...
    return (
      <div className="registry-extensions-page">
        ...
        <p>
          Extensions add features to Sourcegraph and other connected tools (such
          as editors, code hosts, and code review tools).
        </p>
        <FilteredConnection<
          GQL.IRegistryExtension,
          Omit<RegistryExtensionNodeSiteAdminProps, "node">
        >
