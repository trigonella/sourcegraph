...
export const enterpriseSiteAdminAreaRoutes: readonly SiteAdminAreaRoute[] = [
  ...
  },
  {
    ...
    render :
        lazyComponent(() => import('./dotcom/customers/SiteAdminCustomersPage'),
  ...
  },
  {
    ...
    render : lazyComponent(
        () => import(
            './dotcom/productSubscriptions/SiteAdminCreateProductSubscriptionPage'),
  ...
  },
  {
    ...
    render : lazyComponent(
        () => import(
            './dotcom/productSubscriptions/SiteAdminProductSubscriptionPage'),
        'SiteAdminProductSubscriptionPage'),
    exact : true,
  },
  {
    ...
    render : lazyComponent(
        () => import(
            './dotcom/productSubscriptions/SiteAdminProductSubscriptionsPage'),
  ...
  },
  {
    ...
    render : lazyComponent(
        () => import(
            './dotcom/productSubscriptions/SiteAdminProductLicensesPage'),
  ...
  },
  {
    path : '/auth/providers',
    render :
        lazyComponent(() => import('./SiteAdminAuthenticationProvidersPage'),
                      'SiteAdminAuthenticationProvidersPage'),
    exact : true,
  },
  {
    path : '/auth/external-accounts',
    render : lazyComponent(() => import('./SiteAdminExternalAccountsPage'),
                           'SiteAdminExternalAccountsPage'),
    exact : true,
  },
  {
    path : '/registry/extensions',
    render : lazyComponent(() => import('./SiteAdminRegistryExtensionsPage'),
                           'SiteAdminRegistryExtensionsPage'),
    exact : true,
  },
  {
    path : '/code-intelligence/uploads',
    render : lazyComponent(() => import('../codeintel/CodeIntelUploadsPage'),
                           'CodeIntelUploadsPage'),
    exact : true,
  },
  {
    path : '/code-intelligence/uploads/:id',
    render : lazyComponent(() => import('../codeintel/CodeIntelUploadPage'),
                           'CodeIntelUploadPage'),
    exact : true,
  },
  {
    path : '/code-intelligence/indexes',
    render : lazyComponent(() => import('../codeintel/CodeIntelIndexesPage'),
                           'CodeIntelIndexesPage'),
    exact : true,
  },
  {
    path : '/code-intelligence/indexes/:id',
    render : lazyComponent(() => import('../codeintel/CodeIntelIndexPage'),
                           'CodeIntelIndexPage'),
    exact : true,
  },
  {
    path : '/lsif-uploads/:id',
    render : lazyComponent(() => import('./SiteAdminLsifUploadPage'),
                           'SiteAdminLsifUploadPage'),
    exact : true,
  },
]
