            ...
            <div className="text-nowrap">
              {this.props.node.authenticationURL && (
                <a
                  ...
                  href={this.props.node.authenticationURL}
                >
                  Authenticate
                </a>
              )}
...
class FilteredAuthProviderConnection extends FilteredConnection<
  GQL.IAuthProvider
> {}
 ...
 */
export class SiteAdminAuthenticationProvidersPage extends React.Component<
  Props
> {
    ...
    return (
      <div className="site-admin-authentication-page">
        ...
        <p>
          ...
          <a href="https://docs.sourcegraph.com/admin/auth">
            authentication documentation
          </a>{" "}
          about configuring single-sign-on (SSO) via SAML and OpenID Connect.
          Configure authentication providers in the{" "}
          <a href="https://docs.sourcegraph.com/admin/config/site_config">
            site configuration
          </a>
          .
        </p>
  ...
  private queryAuthProviders = (args: {}): Observable<
    GQL.IAuthProviderConnection
  > =>
    queryGraphQL(
      gql`
        query AuthProviders {
