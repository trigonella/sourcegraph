...
import {
  fetchLsifUpload as defaultFetchUpload,
  deleteLsifUpload,
  Upload
} from "./backend";
...
export interface CodeIntelUploadPageProps
...
const terminalStates = new Set([
  LSIFUploadState.COMPLETED,
  LSIFUploadState.ERRORED
]);
...
export const CodeIntelUploadPage: FunctionComponent<CodeIntelUploadPageProps> = ({
  ...
  useEffect(() => telemetryService.logViewEvent("CodeIntelUpload"), [
    telemetryService
  ]);
        ...
        <>
          ...
          {uploadOrError.state === LSIFUploadState.UPLOADING ? (
            ...
            <div className="alert alert-primary mb-4 mt-3">
              ...
              <span className="test-upload-state">
                Upload is queued. There are {uploadOrError.placeInQueue} uploads
                ahead of this one.
              </span>
            </div>
          )}
          ...
          <div className="mt-4 p-2 pt-2">
            ...
            >
              Deleting this upload makes it immediately unavailable to answer
