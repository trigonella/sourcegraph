...
import {
  fetchLsifIndexes as defaultFetchLsifIndexes,
  deleteLsifIndex,
  Index
} from "./backend";
...
const IndexNode: FunctionComponent<IndexNodeProps> = ({
  ...
  return deletionOrError && isErrorLike(deletionOrError) ? (
    <ErrorAlert
      prefix="Error deleting LSIF index"
...
export interface CodeIntelIndexesPageProps
...
export const CodeIntelIndexesPage: FunctionComponent<CodeIntelIndexesPageProps> = ({
  ...
  useEffect(() => telemetryService.logViewEvent("CodeIntelIndexes"), [
    telemetryService
  ]);
  ...
  const queryIndexes = useCallback(
    (args: FilteredConnectionQueryArguments) =>
      fetchLsifIndexes({ repository: repo?.id, ...args }),
  ...
  return (
    <div className="code-intel-indexes">
      ...
      <p>
        ...
        <a
          href="https://github.com/sourcegraph/lsif-go"
          target="_blank"
