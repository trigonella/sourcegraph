...
const RepoSettingsPermissionsPage = lazyComponent<
  RepoSettingsPermissionsPageProps,
  "RepoSettingsPermissionsPage"
>(() => import("./RepoSettingsPermissionsPage"), "RepoSettingsPermissionsPage");
const CodeIntelUploadsPage = lazyComponent<
  CodeIntelUploadsPageProps,
  "CodeIntelUploadsPage"
>(() => import("../../codeintel/CodeIntelUploadsPage"), "CodeIntelUploadsPage");
const CodeIntelUploadPage = lazyComponent<
  CodeIntelUploadPageProps,
  "CodeIntelUploadPage"
>(() => import("../../codeintel/CodeIntelUploadPage"), "CodeIntelUploadPage");
const CodeIntelIndexesPage = lazyComponent<
  CodeIntelIndexesPageProps,
  "CodeIntelIndexesPage"
>(() => import("../../codeintel/CodeIntelIndexesPage"), "CodeIntelIndexesPage");
const CodeIntelIndexPage = lazyComponent<
  CodeIntelIndexPageProps,
  "CodeIntelIndexPage"
>(() => import("../../codeintel/CodeIntelIndexPage"), "CodeIntelIndexPage");
