...
export const android: RepogroupMetadata = {
  ...
  url: "/android",
  description:
    "Use these search suggestions to explore popular Android repositories on GitHub.",
  examples: [
    {
    ...
    {
      title:
        "Examine and optimize your layout by detecting nested LinearLayouts",
      ...
      exampleQuery: (
        <>
          {
            "<LinearLayout:[_]>:[_]<LinearLayout:[_]>:[_]</LinearLayout>:[_]</LinearLayout>"
          }
        </>
      ),
      rawQuery:
    ...
    {
      title:
        "Find usage examples of the OnClickListener function in Kotlin’s syntax",
      exampleQuery: (
        <>
