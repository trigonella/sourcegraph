...
const extensionMarker = document.querySelector<HTMLDivElement>(
  "#sourcegraph-app-background"
);
...
const checkChromeExtensionInstalled = (): Observable<boolean> => {
  ...
  return fromFetch(
    `chrome-extension://${CHROME_EXTENSION_ID}/img/icon-16.png`,
    {
 ...
 */
export function stripURLParameters(
  url: string,
