...
export class AccessTokenNode extends React.PureComponent<
  AccessTokenNodeProps,
  AccessTokenNodeState
> {
        ...
        .pipe(
          ...
          switchMap(() =>
            deleteAccessToken(this.props.node.id).pipe(
              ...
              startWith<Pick<AccessTokenNodeState, "deletionOrError">>({
  ...
  public render(): JSX.Element | null {
    ...
    return (
      <li
        className="list-group-item p-3 d-block"
        data-test-access-token-description={this.props.node.note}
      >
