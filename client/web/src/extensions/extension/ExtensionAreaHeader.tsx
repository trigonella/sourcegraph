...
interface ExtensionAreaHeaderProps
  extends ExtensionAreaRouteContext,
    RouteComponentProps<{}> {
  navItems: readonly ExtensionAreaHeaderNavItem[];
  className: string;
}

export type ExtensionAreaHeaderContext = Pick<
  ExtensionAreaHeaderProps,
  "extension"
>;

export interface ExtensionAreaHeaderNavItem
  extends NavItemWithIconDescriptor<ExtensionAreaHeaderContext> {}
...
export const ExtensionAreaHeader: React.FunctionComponent<ExtensionAreaHeaderProps> = (
  ...
  const manifest: ExtensionManifest | undefined =
    props.extension.manifest && !isErrorLike(props.extension.manifest)
            ...
            <div className="extension-area-header__wrapper">
              <div className="mb-3">
                <div className="d-flex align-items-start">
                  ...
                  <div>
                    <h1 className="d-flex align-items-center mb-0 font-weight-normal">
                      {name}
                    </h1>
                ...
                {change && (
                  <div
                    className={classNames(
                      "alert px-2 py-1 mb-0 extension-area-header__alert",
                      {
                  ...
                  >
                    <span className="font-weight-semibold">{name}</span> is{" "}
                    {change}
                  </div>
                )}
                {showCta && (
