...
interface Props {
  ...
  onSelectCategories: (
    categoriesOrCallback:
      | ExtensionCategory[]
      | ((categories: ExtensionCategory[]) => ExtensionCategory[])
  ) => void;

  enablementFilter: ExtensionsEnablement;

  setEnablementFilter: React.Dispatch<
    React.SetStateAction<ExtensionsEnablement>
  >;
}
          ...
          return (
            <button
              ...
              className={`btn btn-sm mr-2 ${
                selected ? "btn-secondary" : "btn-outline-secondary"
              }`}
