...
export const KEYBOARD_SHORTCUT_SHOW_COMMAND_PALETTE: KeyboardShortcut = {
  ...
  keybindings : [
    {held : [ 'Control' ], ordered : [ 'p' ]}, {ordered : [ 'F1' ]},
    {held : [ 'Alt' ], ordered : [ 'x' ]}
  ],
}
...
/**
 * Global keyboard shortcuts. React components should access these via {@link
 * KeybindingsProps}, not globally.
 */
export const KEYBOARD_SHORTCUTS: KeyboardShortcut[] =
    ...
    /**
       A partial React props type for components that use or propagate keyboard
       shortcuts.
     */
