...
export const ServerBanner: React.FunctionComponent = () => (
  <DismissibleAlert
    partialStorageKey="set-up-self-hosted"
...
export const ServerBannerNoRepo: React.FunctionComponent = () => (
  ...
  >
    <span>
      Sourcegraph.com searches over the top 100k GitHub repositories by default.
      You can search over other public repositories by providing a repo: filter
      or you can search all of your own private code by{" "}
      <a
        href="https://docs.sourcegraph.com/#quickstart"
        onClick={onClickInstall}
      >
