...
export const SearchHelpDropdownButton: React.FunctionComponent = () => {
  ...
  const documentationUrlPrefix = window.context?.sourcegraphDotComMode
  ...
  return (
    <ButtonDropdown
      isOpen={isOpen}
      toggle={toggleIsOpen}
      className="search-help-dropdown-button d-flex"
    >
      <DropdownToggle
        tag="span"
        caret={false}
      ...
      <DropdownMenu right={true} className="pb-0">
        ...
        {window.context?.sourcegraphDotComMode && (
          <div className="p-2 alert alert-info small rounded-0 mb-0 mt-1">
            On Sourcegraph.com, use a <code>repo:</code> filter to narrow your
            search to &le;500 repositories.
          </div>
        )}
      </DropdownMenu>
    </ButtonDropdown>
