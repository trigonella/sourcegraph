 ...
 */
interface MonacoEditorWithKeybindingsService
 ...
 * */
interface MonacoEditorWithCommandService
  extends Monaco.editor.IStandaloneCodeEditor {
  _commandService: {
...
const hasCommandService = (
  editor: Monaco.editor.IStandaloneCodeEditor
): editor is MonacoEditorWithCommandService =>
  hasProperty("_commandService")(editor) &&
  typeof (editor._commandService as MonacoEditorWithCommandService["_commandService"])
    .addCommand === "function";
 ...
 */
export class MonacoQueryInput extends React.PureComponent<
