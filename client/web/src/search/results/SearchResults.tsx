...
import {
  ...
  SearchScopeWithOptionalName
} from "./SearchResultsFilterBars";
...
export interface SearchResultsProps
  extends ExtensionsControllerProps<
      "executeCommand" | "extHostAPI" | "services"
    >,
...
> {
        ...
        .pipe(
          ...
          filter(
            (
              ...
              !!queryAndPatternTypeAndCase.query &&
              !!queryAndPatternTypeAndCase.patternType
          ),
          tap(({ query, caseSensitive }) => {
            ...
            this.props.telemetryService.log("SearchResultsQueried", {
              ...
              ...(this.props.splitSearchModes
                ? {
                    mode: this.props.interactiveSearchMode
                      ? "interactive"
                      : "plain"
                  }
                : {})
            ...
            concat(
              ...
              this.props
                .searchRequest(
                  ...
                  resolveVersionContext(
                    versionContext,
                    this.props.availableVersionContexts
                  ),
                ...
                .pipe(
                  ...
                  tap(
                    ...
                    error => {
                      this.props.telemetryService.log(
            ...
            this.setState({
              showVersionContextWarning:
                (props.availableVersionContexts &&
                  versionFromURL !== props.previousVersionContext) ||
                false
            });
          }
        })
  ...
  private onModalClose = (): void => {
    this.props.telemetryService.log("SavedQueriesToggleCreating", {
      queries: { creating: false }
    });
  ...
  public render(): JSX.Element | null {
    ...
    const quickLinks =
      (isSettingsValid<Settings>(this.props.settingsCascade) &&
        this.props.settingsCascade.final.quicklinks) ||
      [];
          ...
          <div className="mt-2 mx-2">
            <div className="d-flex alert alert-warning mb-0 justify-content-between">
              <div>
                ...
                <strong>{this.props.versionContext || "default"}</strong>. You
                can switch contexts with the selector to the left of the search
                bar.
              </div>
  ...
  private getFilters(): SearchScopeWithOptionalName[] {
    ...
    if (
      ...
      dynamicFilters = this.state.resultsOrError.dynamicFilters.filter(
        filter => filter.kind !== "repo"
      );
  ...
  private onExpandAllResultsToggle = (): void => {
    this.setState(
      ...
      () => {
        this.props.telemetryService.log(
          this.state.allExpanded ? "allResultsExpanded" : "allResultsCollapsed"
        );
      }
    );
  };
  ...
  private onDynamicFilterClicked = (value: string): void => {
    ...
    const newQuery = toggleSearchFilter(
