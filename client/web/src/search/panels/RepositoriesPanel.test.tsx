...
describe("RepositoriesPanel", () => {
    ...
    const recentSearches = {
      nodes: [
        ...
        },
        {
          ...
          url:
            "https://sourcegraph.test:3443/search?q=repo:test&patternType=literal"
        }
      ],
      pageInfo: {
        endCursor: null,
      ...
      nodes: [
        {
          ...
          url:
            "https://sourcegraph.test:3443/search?q=r:test&patternType=literal"
        },
        {
          argument:
            '{"mode": "plain", "code_search": {"query_data": {"empty": false, "query": {"chars": {"count": 13, "space": 0, "non_ascii": 0, "double_quote": 0, "single_quote": 0}, "fields": {"count": 1, "count_non_default": 1}, "field_repo": {"count": 1, "value_glob": 0, "value_pipe": 0, "count_alias": 1, "value_regexp": 0, "count_negated": 0, "value_at_sign": 0, "value_rev_star": 0, "value_rev_caret": 0, "value_rev_colon": 0}, "field_default": {"count": 0, "count_regexp": 0, "count_literal": 0, "count_pattern": 0, "count_double_quote": 0, "count_single_quote": 0}}, "combined": "r:sourcegraph"}}}',
          timestamp: "2020-09-04T18:44:39Z",
          url:
            "https://sourcegraph.test:3443/search?q=r:sourcegraph+test&patternType=literal"
        },
        {
          argument:
            '{"mode": "plain", "code_search": {"query_data": {"empty": false, "query": {"chars": {"count": 13, "space": 0, "non_ascii": 0, "double_quote": 0, "single_quote": 0}, "fields": {"count": 1, "count_non_default": 1}, "field_repo": {"count": 1, "value_glob": 0, "value_pipe": 0, "count_alias": 1, "value_regexp": 0, "count_negated": 0, "value_at_sign": 0, "value_rev_star": 0, "value_rev_caret": 0, "value_rev_colon": 0}, "field_default": {"count": 0, "count_regexp": 0, "count_literal": 0, "count_pattern": 0, "count_double_quote": 0, "count_single_quote": 0}}, "combined": "r:sourcegraph"}}}',
    ...
    const recentSearches = {
      nodes: [
        ...
        },
        {
          ...
          timestamp: "2020-09-04T18:44:30Z",
          url:
            "https://sourcegraph.test:3443/search?q=r:test-two&patternType=literal"
        }
      ],
      pageInfo: {
        endCursor: null,
  ...
  test("Show More button loads more items", () => {
    ...
    const recentSearches2 = {
      nodes: [
        ...
        },
        {
          ...
          timestamp: "2020-09-08T17:36:52Z",
          url:
            "https://sourcegraph.test:3443/search?q=r:test-three&patternType=literal"
        },
        {
          argument:
            '{"mode": "plain", "code_search": {"query_data": {"empty": false, "query": {"chars": {"count": 13, "space": 0, "non_ascii": 0, "double_quote": 0, "single_quote": 0}, "fields": {"count": 1, "count_non_default": 1}, "field_repo": {"count": 1, "value_glob": 0, "value_pipe": 0, "count_alias": 1, "value_regexp": 0, "count_negated": 0, "value_at_sign": 0, "value_rev_star": 0, "value_rev_caret": 0, "value_rev_colon": 0}, "field_default": {"count": 0, "count_regexp": 0, "count_literal": 0, "count_pattern": 0, "count_double_quote": 0, "count_single_quote": 0}}, "combined": "r:sourcegraph"}}}',
          timestamp: "2020-09-04T18:44:39Z",
          url:
            "https://sourcegraph.test:3443/search?q=r:r:test-four&patternType=literal"
        },
        {
          argument:
            '{"mode": "plain", "code_search": {"query_data": {"empty": false, "query": {"chars": {"count": 13, "space": 0, "non_ascii": 0, "double_quote": 0, "single_quote": 0}, "fields": {"count": 1, "count_non_default": 1}, "field_repo": {"count": 1, "value_glob": 0, "value_pipe": 0, "count_alias": 1, "value_regexp": 0, "count_negated": 0, "value_at_sign": 0, "value_rev_star": 0, "value_rev_caret": 0, "value_rev_colon": 0}, "field_default": {"count": 0, "count_regexp": 0, "count_literal": 0, "count_pattern": 0, "count_double_quote": 0, "count_single_quote": 0}}, "combined": "r:sourcegraph"}}}',
          timestamp: "2020-09-04T18:44:30Z",
          url:
            "https://sourcegraph.test:3443/search?q=r:test-five&patternType=literal"
        }
      ],
      pageInfo: {
        endCursor: null,
    ...
    const showMoreButton = component.find(
      "button.test-repositories-panel-show-more"
    );
