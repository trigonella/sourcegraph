...
export const RepogroupPanel: React.FunctionComponent<Props> = ({
  className,
  telemetryService
}) => {
  const logRepogroupClicked = useCallback(
    () => telemetryService.log("RepogroupPanelRepogroupClicked"),
    [telemetryService]
  );
