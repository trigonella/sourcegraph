...
export const _fetchSavedSearches = (): Observable<ISavedSearch[]> => of([
  {
...
export const _fetchRecentSearches =
    ():
              ...
              nodes : [
                {
                  ...
                  url :
                      'https://sourcegraph.test:3443/search?q=test&patternType=literal',
                },
                {
                  argument :
                  ...
                  url :
                      'https://sourcegraph.test:3443/search?q=%5Etest&patternType=regexp',
                },
                {
                  argument :
                      '{"mode": "plain", "code_search": {"query_data": {"empty": false, "query": {"chars": {"count": 5, "space": 0, "non_ascii": 0, "double_quote": 0, "single_quote": 0}, "fields": {"count": 1, "count_non_default": 0}, "field_default": {"count": 1, "count_regexp": 1, "count_literal": 1, "count_pattern": 0, "count_double_quote": 0, "count_single_quote": 0}}, "combined": "^test"}}}',
                ...
                },
                {
                  ...
                  url :
                      'https://sourcegraph.test:3443/search?q=repo:sourcegraph/sourcegraph&patternType=literal',
                },
                {
                  argument :
                      '{"mode": "plain", "code_search": {"query_data": {"empty": false, "query": {"chars": {"count": 4, "space": 0, "non_ascii": 0, "double_quote": 0, "single_quote": 0}, "fields": {"count": 1, "count_non_default": 0}, "field_default": {"count": 1, "count_regexp": 0, "count_literal": 1, "count_pattern": 0, "count_double_quote": 0, "count_single_quote": 0}}, "combined": "test"}}}',
                ...
                },
                {
                  ...
                  url :
                      'https://sourcegraph.test:3443/search?q=r:sourcegraph&patternType=literal',
                },
                {
                  argument :
                      '{"mode": "plain", "code_search": {"query_data": {"empty": false, "query": {"chars": {"count": 4, "space": 0, "non_ascii": 0, "double_quote": 0, "single_quote": 0}, "fields": {"count": 1, "count_non_default": 0}, "field_default": {"count": 1, "count_regexp": 0, "count_literal": 1, "count_pattern": 0, "count_double_quote": 0, "count_single_quote": 0}}, "combined": "test"}}}',
...
export const _fetchRecentFileViews = (): Observable<EventLogResult|null> => of({
  nodes : [
    {
      argument :
          '{"filePath": "web/src/tree/Tree.tsx", "repoName": "github.com/sourcegraph/sourcegraph"}',
      timestamp : '2020-09-10T23:07:55Z',
      url :
          'https://sourcegraph.test:3443/github.com/sourcegraph/sourcegraph/-/blob/web/src/tree/Tree.tsx',
    },
    {
      argument :
          '{"filePath": "web/src/tree/TreeRoot.tsx", "repoName": "github.com/sourcegraph/sourcegraph"}',
      timestamp : '2020-09-10T23:07:55Z',
      url :
    ...
    {
      argument :
          '{"filePath": "web/jest.config.js", "repoName": "github.com/sourcegraph/sourcegraph"}',
      timestamp : '2020-09-10T23:07:45Z',
      url :
          'https://sourcegraph.test:3443/github.com/sourcegraph/sourcegraph/-/blob/web/jest.config.js',
    },
    {
      argument :
          '{"filePath": "go.mod", "repoName": "ghe.sgdev.org/sourcegraph/gorilla-mux"}',
      timestamp : '2020-09-10T22:55:30Z',
      url :
          'https://sourcegraph.test:3443/ghe.sgdev.org/sourcegraph/gorilla-mux/-/blob/go.mod',
    },
    {
      argument :
          '{"filePath": ".eslintrc.js", "repoName": "github.com/sourcegraph/sourcegraph"}',
      timestamp : '2020-09-10T22:55:18Z',
      url :
          'https://sourcegraph.test:3443/github.com/sourcegraph/sourcegraph/-/blob/.eslintrc.js',
    },
    {
      argument :
          '{"filePath": "go.mod", "repoName": "ghe.sgdev.org/sourcegraph/gorilla-mux"}',
    ...
    {
      argument :
          '{"filePath": "AUTHORS", "repoName": "ghe.sgdev.org/sourcegraph/gorilla-mux"}',
      timestamp : '2020-09-10T21:21:23Z',
      url :
          'https://sourcegraph.test:3443/ghe.sgdev.org/sourcegraph/gorilla-mux/-/blob/AUTHORS',
    },
    {
      argument :
          '{"filePath": "LICENSE", "repoName": "ghe.sgdev.org/sourcegraph/gorilla-mux"}',
      timestamp : '2020-09-10T21:21:23Z',
      url :
          'https://sourcegraph.test:3443/ghe.sgdev.org/sourcegraph/gorilla-mux/-/blob/LICENSE',
    },
    {
      argument :
          '{"filePath": "README.md", "repoName": "ghe.sgdev.org/sourcegraph/gorilla-mux"}',
      timestamp : '2020-09-10T21:21:22Z',
      url :
          'https://sourcegraph.test:3443/ghe.sgdev.org/sourcegraph/gorilla-mux/-/blob/README.md',
    },
    {
      argument :
    ...
    {
      argument :
          '{"filePath": "example_route_test.go", "repoName": "ghe.sgdev.org/sourcegraph/gorilla-mux"}',
      timestamp : '2020-09-10T21:21:19Z',
      url :
          'https://sourcegraph.test:3443/ghe.sgdev.org/sourcegraph/gorilla-mux/-/blob/example_route_test.go',
    },
    {
      argument :
          '{"filePath": "go.mod", "repoName": "ghe.sgdev.org/sourcegraph/gorilla-mux"}',
    ...
    {
      argument :
          '{"filePath": "mux_test.go", "repoName": "ghe.sgdev.org/sourcegraph/gorilla-mux"}',
      timestamp : '2020-09-10T21:21:03Z',
      url :
          'https://sourcegraph.test:3443/ghe.sgdev.org/sourcegraph/gorilla-mux/-/blob/mux_test.go',
    },
  ],
  totalCount : 500,
