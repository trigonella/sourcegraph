...
export class ActionItem extends React.PureComponent<ActionItemProps, State> {
    ...
    this.subscriptions.add(
      this.commandExecutions
        .pipe(
          mergeMap(parameters =>
            from(
              this.props.extensionsController.executeCommand(
                parameters,
  ...
  public componentDidUpdate(
    ...
    const errorTooltipChanged =
      ...
      (isErrorLike(previousState.actionOrError) !==
        ...
        (isErrorLike(previousState.actionOrError) &&
          isErrorLike(this.state.actionOrError) &&
          previousState.actionOrError.message !==
            this.state.actionOrError.message));
  ...
  public render(): JSX.Element | null {
    ...
    const variantClassName =
      this.props.variant === "actionItem"
        ? "action-item--variant-action-item"
        : "";
    ...
    const showLoadingSpinner =
      this.props.showLoadingSpinnerDuringExecution &&
    ...
    const altTo =
      ...
      urlForClientCommandOpen(this.props.altAction, this.props.location);
    const primaryTo = urlForClientCommandOpen(
      this.props.action,
      this.props.location
    );
    ...
    return (
      <ButtonLink
        ...
        disabled={
          (this.props.disabledDuringExecution ||
            this.props.showLoadingSpinnerDuringExecution) &&
          this.state.actionOrError === LOADING
        }
      ...
      >
        {content}{" "}
        {primaryTo && isExternalLink(primaryTo) && (
  ...
  public runAction = (
    ...
    const action =
      (isAltEvent(event) && this.props.altAction) || this.props.action;
...
function urlForClientCommandOpen(
  action: Evaluated<ActionContribution>,
  location: H.Location
): string | undefined {
