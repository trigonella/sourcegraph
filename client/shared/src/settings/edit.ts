 ...
 *
 * @param applySettingsEdit A function that is called to actually apply and
 *     persist the update.
 */
 ...
 * subject.
 *
 * @param edit An edit to a specific value in the settings, or a stringified
 *     JSON value to overwrite the entire
 * settings.
 */
 ...
 * subject.
 *
 * This function uses configurationMutation (not settingsMutation) and
 * editConfiguration (not editSettings) for backcompat.
 *
 ...
 * subject.
 *
 * NOTE: This GraphQL query is only compatible with Sourcegraph 2.13 and newer
 * (due to the use of Mutation.settingsMutation and
 * SettingsMutation.overwriteSettings).
 *
 * @param contents A stringified JSON value to overwrite the entire settings
 *     with.
 */
