...
/**
 * Returns the hover result for a hovered search token in the Monaco query
 * input.
 */
export const getHoverResult = ({members}: Pick<Sequence, 'members'>,
  ...
  return {
    contents:
        [
          {
            value : 'negated' in resolvedFilter
                        ? resolvedFilter.definition.description(
                              resolvedFilter.negated)
                        : resolvedFilter.definition.description,
          },
        ],
