...
export class ExtensionLanguageFeatures {
  constructor(
    private proxy: comlink.Remote<ClientLanguageFeaturesAPI>,
  ...
  public registerDefinitionProvider(
    ...
    return syncSubscription(
      this.proxy.$registerDefinitionProvider(
  ...
  public registerReferenceProvider(
    ...
    return syncSubscription(
      this.proxy.$registerReferenceProvider(
        fromDocumentSelector(selector),
        providerFunction
      )
    );
  ...
  public registerCompletionItemProvider(
    ...
    return syncSubscription(
      this.proxy.$registerCompletionItemProvider(
        fromDocumentSelector(selector),
        providerFunction
      )
    );
...
function toLocations(
  result: Location[] | Location | null | undefined
): clientType.Location[] {
  return result
    ? (Array.isArray(result) ? result : [result]).map(location =>
