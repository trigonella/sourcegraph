...
export interface ClientLanguageFeaturesAPI extends ProxyMarked {
  ...
  $registerReferenceProvider(
    selector: DocumentSelector,
    providerFunction: Remote<
      ((parameters: ReferenceParameters) => ProxySubscribable<Location[]>) &
        ProxyMarked
    >
  ): Unsubscribable & ProxyMarked;
...
export class ClientLanguageFeatures
  implements ClientLanguageFeaturesAPI, ProxyMarked {
  public readonly [proxyMarker] = true;

  constructor(
    private definitionRegistry: TextDocumentLocationProviderRegistry,
    private referencesRegistry: TextDocumentLocationProviderRegistry<
      ReferenceParameters
    >,
