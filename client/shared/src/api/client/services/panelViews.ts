...
> {
  ...
  /**
   * Returns an observable that emits all panel views whenever the set of
   * registered panel view providers or their properties change. If any provider
...
/**
 * Exported for testing only. Most callers should use {@link
 * ViewProviderRegistry#getPanelView}, which uses the registered panel view
 * providers.
 *
 * @internal
 */
...
/**
 * Exported for testing only. Most callers should use {@link
 * ViewProviderRegistry#getPanelViews}, which uses the registered panel view
 * providers.
 *
 * @internal
 */
