 ...
 * This is needed because if sourcegraph.NotificationType enum values are
 * referenced, the `sourcegraph` module import at the top of the file is emitted
...
type ShowMessageRequest = ShowMessageRequestParameters &
  PromiseCallback<MessageActionItem | null>;
...
export class NotificationsService {
  ...
  /** Messages from extensions requesting the user to select an action. */
  public readonly progresses = new Subject<{
    title?: string;
    progress: Observable<sourcegraph.Progress>;
  }>();
