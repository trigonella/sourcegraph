...
/**
 * Returns an observable that emits all decorations whenever any of the
 * last-emitted set of providers emits decorations.
 *
 * Most callers should use TextDocumentDecorationProviderRegistry, which uses
...
/**
 * Resolves the actual styles to use for the badge attachment based on the
 * current theme.
 */
