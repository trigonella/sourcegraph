...
/**
 * Describes a configured extension with an optional associated registry
 * extension. Prefer using
 * {@link ConfiguredExtension} when it is not necessary to access the registry
