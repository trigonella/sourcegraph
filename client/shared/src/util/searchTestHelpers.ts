...
export const RESULT = {
  ...
  repository :
      {name : 'github.com/golang/oauth2', url : '/github.com/golang/oauth2'} as
          IRepository,
  limitHit : false,
  symbols : [] as ISymbol[],
  lineMatches : [
...
export const MULTIPLE_MATCH_RESULT = {
  ...
  file : {
    ...
    url :
        '/github.com/golang/oauth2/-/blob/clientcredentials/clientcredentials_test.go',
    commit : {
...
export const HIGHLIGHTED_FILE_LINES =
    ...
    export const HIGHLIGHTED_FILE_LINES_REQUEST =
        sinon.fake.returns(of(HIGHLIGHTED_FILE_LINES))
export const HIGHLIGHTED_FILE_LINES_SIMPLE_REQUEST =
    sinon.fake.returns(of(HIGHLIGHTED_FILE_LINES_SIMPLE))
...
export const extensionsController:
    Pick<Controller, 'executeCommand'|'services'|'extHostAPI'> = {
