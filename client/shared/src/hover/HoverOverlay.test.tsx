...
const renderShallow = (
  element: React.ReactElement<HoverOverlayProps>
): React.ReactElement => {
...
describe("HoverOverlay", () => {
  const NOOP_EXTENSIONS_CONTROLLER = {
  ...
  test("actions and hover undefined", () => {
    expect(
      renderer.create(<HoverOverlay {...commonProps} />).toJSON()
    ).toMatchSnapshot();
  });
  ...
  test("actions loading", () => {
    expect(
      renderer
        .create(<HoverOverlay {...commonProps} actionsOrError="loading" />)
        .toJSON()
    ).toMatchSnapshot();
  });
  ...
  test("hover loading", () => {
    expect(
      renderer
        .create(<HoverOverlay {...commonProps} hoverOrError="loading" />)
        .toJSON()
    ).toMatchSnapshot();
  });
  ...
  test("actions empty", () => {
    const component = renderer.create(
      <HoverOverlay {...commonProps} actionsOrError={[]} />
    );
  ...
  test("hover empty", () => {
    expect(
      renderer
        .create(<HoverOverlay {...commonProps} hoverOrError={null} />)
        .toJSON()
    ).toMatchSnapshot();
  });
    ...
    expect(
      renderShallow(
        <HoverOverlay
          {...commonProps}
          actionsOrError={[
            { action: { id: "a", command: "c", title: "Some title" } }
          ]}
        />
      )
    ).toMatchSnapshot();
