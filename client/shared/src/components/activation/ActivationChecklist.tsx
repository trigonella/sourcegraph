...
export const ActivationChecklistItem: React.FunctionComponent<ActivationChecklistItemProps> = ({
  ...
  <div
    className={classNames(
      "activation-checklist-item d-flex justify-content-between",
      className
    )}
  >
 ...
 */
export class ActivationChecklist extends React.PureComponent<
...
> {
  public render(): JSX.Element {
    return this.props.completed ? (
      <div
        className={`activation-checklist list-group list-group-flush ${this
          .props.className || ""}`}
      >
          ...
          {this.props.steps.map(step => (
            ...
            >
              ...
              <AccordionPanel className="px-2">
                <div className="activation-checklist__detail pb-1">
                  {step.detail}
                </div>
              </AccordionPanel>
            </AccordionItem>
