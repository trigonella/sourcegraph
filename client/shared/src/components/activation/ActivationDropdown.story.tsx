...
import {
  ActivationDropdown,
  ActivationDropdownProps
} from "./ActivationDropdown";
...
const { add } = storiesOf("shared/ActivationDropdown", module).addDecorator(
  story => (
    <>
...
add("Loading", () => (
  <ActivationDropdown {...commonProps} activation={baseActivation} />
));
add("0/4 completed", () => (
  <ActivationDropdown
    {...commonProps}
