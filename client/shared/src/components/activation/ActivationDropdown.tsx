...
export interface ActivationDropdownProps
  extends Pick<MenuPopoverProps, "portal"> {
  history: H.History;
 ...
 */
export class ActivationDropdown extends React.PureComponent<
...
> {
    ...
    this.subscriptions.add(
      this.componentUpdates
        .pipe(
          ...
          concatMap(() =>
            concat(of(true), of(false).pipe(delay(animationDurationMillis)))
          )
        )
  ...
  public render(): JSX.Element | null {
    const show =
      ...
      this.state.animate ||
      (this.props.activation.completed !== undefined &&
