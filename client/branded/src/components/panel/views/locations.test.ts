...
test('groups 2 levels',
     () => expect(groupLocations<TestLocation, TestGroup>(
                      LOCATIONS, null, GROUP_KEYS, LOCATIONS[0]))
               .toEqual({
                 groups : [
                   [
                     {key : 'a', count : 3},
...
test('supports initial selectedGroups',
     () => expect(groupLocations<TestLocation, TestGroup>(
                      LOCATIONS, [ 'b', 'a' ], GROUP_KEYS, LOCATIONS[0]))
               .toEqual({
                 groups : [
                   [
                     {key : 'a', count : 3},
...
test('handles selectedGroups element that does not exist',
     () => expect(groupLocations<TestLocation, TestGroup>(
                      LOCATIONS, [ 'b', 'x' ], GROUP_KEYS, LOCATIONS[0]))
               .toEqual({
                 groups : [
                   [
                     {key : 'a', count : 3},
...
test('resolves selectedGroups undefined element',
     () => expect(groupLocations<TestLocation, TestGroup>(
                      LOCATIONS, [ 'a' ], GROUP_KEYS, LOCATIONS[0]))
               .toEqual({
                 groups : [
                   [
                     {key : 'a', count : 3},
