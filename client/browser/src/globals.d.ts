...
/**
 * Set by the browser extension content, background and option page entry
 * scripts.
 */
...
/** Set by native integrations. */
declare var SOURCEGRAPH_INTEGRATION:|'phabricator-integration'|
    'bitbucket-integration'|'gitlab-integration'|undefined
...
declare var gon: {gitlab_url: string}

/** Set from the Phabricator native integration. **/
declare var PHABRICATOR_CALLSIGN_MAPPINGS:|{callsign : string
          path: string
      }[]
    | undefined
