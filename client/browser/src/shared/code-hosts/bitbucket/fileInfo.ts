 ...
 * view.
 */
export const resolveFileInfoForSingleFileSourceView = (
 ...
 */
export const resolvePullRequestFileInfo = (
  codeView: HTMLElement
): Observable<DiffInfo> => {
  const partialFileInfo = getFileInfoWithoutCommitIDsFromMultiFileDiffCodeView(
    codeView
  );
 ...
 */
export const resolveSingleFileDiffFileInfo = (
  codeView: HTMLElement
): Observable<DiffInfo> => {
  const {
    changeType,
