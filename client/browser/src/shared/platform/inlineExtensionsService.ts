 ...
 *
 * This requires the browser extension to be built with inline extensions
 * enabled. At build time this is determined by
...
/**
 * Manages the set of inline (bundled) extensions that are loaded. Only
 * applicable to the Firefox browser add-on.
 *
 * The inline extensions service loads extensions directly from the add-on
 * assets and does not load any code remotely.
 */
