...
/**
 * Returns a platform-appropriate implementation of the function used to make
 * requests to our GraphQL API.
 *
 * In the browser extension, the returned function will make all requests from
 * the background page.
 *
 * In the native integration, the returned function will rely on the
 * `requestGraphQL` implementation from `/shared`.
 */
