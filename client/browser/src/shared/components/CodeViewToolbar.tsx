...
import {
  DiffOrBlobInfo,
  FileInfoWithContent
} from "../code-hosts/shared/codeHost";
...
export interface CodeViewToolbarProps
  extends PlatformContextProps<
      "forceUpdateTooltip" | "settings" | "requestGraphQL"
    >,
...
export const CodeViewToolbar: React.FunctionComponent<CodeViewToolbarProps> = props => (
  <ul className={classNames("code-view-toolbar", props.className)}>
    ...
    {isErrorLike(props.fileInfoOrError) ? (
      ...
      <>
        {!("blob" in props.fileInfoOrError) &&
          props.fileInfoOrError.head &&
          props.fileInfoOrError.base && (
            <li
            ...
            >
              <OpenDiffOnSourcegraph
                ...
                openProps={{
                  ...
                  revision: defaultRevisionToCommitID(
                    props.fileInfoOrError.base
                  ).revision,
                  commit: {
                    baseRev: defaultRevisionToCommitID(
                      props.fileInfoOrError.base
                    ).revision,
                    headRev: defaultRevisionToCommitID(
                      props.fileInfoOrError.head
                    ).revision
                  }
                }}
        ...
        "blob" in props.fileInfoOrError &&
          props.fileInfoOrError.blob.content !== undefined && (
            <li
              className={classNames(
                "code-view-toolbar__item",
                props.listItemClass
