...
export class ConditionalTelemetryService implements TelemetryService {
  ...
  constructor(
    innerTelemetryService: TelemetryService,
...
export class EventLogger implements TelemetryService {
  ...
  public async log(eventName: string, eventProperties?: any): Promise<void> {
    switch (eventName) {
      ...
      case "hover":
        await this.logCodeIntelligenceEvent(
          eventName,
          UserEvent.CODEINTELINTEGRATION,
          eventProperties
        );
        break;
      case "findReferences":
        await this.logCodeIntelligenceEvent(
          eventName,
          UserEvent.CODEINTELINTEGRATIONREFS,
          eventProperties
        );
        break;
    }
