...
const Video: React.FunctionComponent<{ name: string } & Pick<
  VideoHTMLAttributes<HTMLVideoElement>,
  "width" | "height"
> &
  ThemeProps> = ({ name, isLightTheme, width, height }) => {
  ...
  <div className="web-content after-install-page-content">
    ...
    <div className="container mt-3">
      ...
      <p className="lead mb-0">
        We’ve gathered the most important information that will get your
        started:
      </p>
    </div>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <p>
              Sourcegraph browser extension adds code intelligence to files and
              diffs on GitHub, GitHub Enterprise, GitLab, Phabricator, and
              Bitbucket Server.
            </p>
            <Video
              {...props}
              name="CodeIntelligenceOnCodeHost"
              width={1760}
              height={1060}
            />
          </div>
          <div className="col-md-6 mt-4 mt-md-0">
            ...
            <p>
              Type <code>src</code>
              <kbd>space</kbd> in the address bar of your browser to search for
              queries on Sourcegraph.
            </p>
            <Video
              {...props}
        ...
        <div className="row">
          <div className="col-md-6 d-flex flex-column">
            ...
            <div className="bg-2 rounded p-3 mb-3 flex-grow-1 d-flex flex-column justify-content-center">
              ...
              <p className="m-0">
                <CheckIcon className="icon-inline" /> No action required. Your
          ...
          <div className="col-md-6 d-flex flex-column">
            ...
            <div className="flex-grow-1 d-flex align-items-center">
              ...
              <p className="flex-grow-1 m-0 ml-3">
                To use the browser extension with your private repositories, you
                need to set up a <strong>private Sourcegraph instance</strong>{" "}
                and connect the extension to it.
              </p>
            </div>
            <div className="flex-grow-1 bg-2 rounded p-3 mt-4 d-flex flex-column justify-content-around">
              ...
              <ol className="m-0 flex-grow-1 d-flex flex-column justify-content-around">
                <li>
                  ...
                  ). Skip this step if you already have a private Sourcegraph
                  instance.
                </li>
                <li>
                ...
                <li>
                  Enter the <strong>URL</strong> (including the protocol) of
                  your Sourcegraph instance (such as{" "}
      ...
      <div className="container">
        ...
        <div className="d-flex w-100 align-items-center">
          ...
          <p className="flex-grow-1 m-0 ml-3">
            ...
            to learn more about how we respect your privacy, troubleshooting and
            extension features.
          </p>
        </div>
      </div>
