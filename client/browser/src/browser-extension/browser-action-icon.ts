 ...
 * action icon.
 */
export type BrowserActionIconState =
    'active'|'active-with-alert'|'inactive' interface BrowserActionIconPaths {
  '16': string
  '48': string
  '128': string
}

const browserActionIconPaths:
    Record<BrowserActionIconState, BrowserActionIconPaths> = {
      active : {
        '16' : 'img/icon-16.png',
        '48' : 'img/icon-48.png',
 ...
 */
export function setBrowserActionIconState(iconState: BrowserActionIconState):
    void {
