...
const validateSourcegraphUrl = (): Observable<string | undefined> =>
  of(undefined);
const invalidSourcegraphUrl = (): Observable<string | undefined> =>
  of("Arbitrary error string");
...
storiesOf("browser/Options/OptionsPage", module)
  .addDecorator(story => (
    <BrandedStory styles={brandedStyles}>{() => story()}</BrandedStory>
  ))
  .add("Default", () => (
    <OptionsPage
      {...commonProps}
