  ...
  return (
    <div
      className={classNames(
        "options-page",
        isFullPage && "options-page--full shadow"
      )}
    >
      ...
      {permissionAlert && (
        <PermissionAlert
          {...permissionAlert}
          onClickGrantPermissions={requestPermissionsHandler}
        />
      )}
...
const PermissionAlert: React.FunctionComponent<PermissionAlertProps> = ({
  ...
  <section className="options-page__section bg-2">
    ...
    <p className="options-page__permission-text">
      <strong>Grant permissions</strong> to use the Sourcegraph extension on{" "}
      {name}.
    </p>
    <button
      type="button"
      onClick={onClickGrantPermissions}
...
const PrivateRepositoryAlert: React.FunctionComponent = () => (
  <section className="options-page__section bg-2">
    ...
    <p>
      To use the browser extension with your private repositories, you need to
      set up a <strong>private Sourcegraph instance</strong> and connect the
      browser extension to it.
    </p>
    <ol>
      <li className="mb-2">
      ...
      <li className="mb-2">
        Click the Sourcegraph icon in the browser toolbar to bring up this popup
        again.
      </li>
      <li className="mb-2">
        Enter the URL (including the protocol) of your Sourcegraph instance
        above, e.g. <q>https://sourcegraph.example.com</q>.
      </li>
      <li>
...
const CodeHostsSection: React.FunctionComponent<{ currentHost?: string }> = ({
  currentHost
}) => (
  <section className="options-page__section">
    <p>
      Get code intelligence tooltips while browsing files and reading PRs on
      your code host.
    </p>
    <div>
...
const SourcegraphCloudAlert: React.FunctionComponent = () => (
  <section className="options-page__section bg-2">
    ...
    <p>
      Naturally, the browser extension is not necessary to browse public code on
      sourcegraph.com.
    </p>
  </section>
);
