...
/**
 * The URL to sourcegraph/jsonrpc2 call_opt.go at commit
 * 4fb7cd90793ee6ab445f466b900e6bffb9b63d78 on the code host
 */
url: string
...
/** The expected URL for the "Go to Definition" button */
    ...
    expect(await getDriver().page.$$('.code-view-toolbar .open-on-sourcegraph'))
        ...
        const lineNumber = 16
        const line = await getDriver().page.waitForSelector(
            `${lineSelector}:nth-child(${lineNumber})`, {
              timeout : 10000,
            })
