...
// By default, these tests run against gitlab.com and a local Sourcegraph
// instance. You can run them against other instances by setting the below env
// vars in addition to SOURCEGRAPH_BASE_URL.
...
before(async function() {
  ...
  if (sourcegraphBaseUrl !== 'https://sourcegraph.com') {
    ...
    await driver.setExtensionSourcegraphUrl() await driver
