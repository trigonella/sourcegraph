...
const buildEntry = (...files: string[]): string[] =>
...
const config: webpack.Configuration = {
  ...
  plugins : [
    ...
    // Code splitting doesn't make sense/work in the browser extension, but we
    // still want to use dynamic import()
