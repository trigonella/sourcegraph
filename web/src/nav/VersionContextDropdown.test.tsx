  ...
  availableVersionContexts: [
    {
      name: "3.0",
      description: "3.0",
      revisions: [{ repo: "github.com/sourcegraph/sourcegraph", rev: "3.0" }]
    },
    {
      name: "3.15",
      description: "3.15",
      revisions: [{ repo: "github.com/sourcegraph/sourcegraph", rev: "3.15" }]
    }
  ],
...
describe("VersionContextDropdown", () => {
  it("renders the version context dropdown with no context selected", () => {
    expect(
      mount(<VersionContextDropdown {...commonProps} />)
    ).toMatchSnapshot();
  });
