          ...
          <ListboxInput value={currentVersionContext} onChange={updateValue}>
            {({ isExpanded }) => (
              <>
                ...
                <ListboxPopover
                  className={classNames(
                    "version-context-dropdown__popover dropdown-menu",
                    {
                  ...
                  {!hasDismissedInfo && (
                    <div className="version-context-dropdown__info card">
                      ...
                      <p className="mb-2">
                        ...
                        ) allow you to search a set of repositories based on a
                        commit hash, tag, or other interesting moment in time of
                        multiple code bases. Your administrator can configure
                        version contexts in the site configuration.
                      </p>
                      <button
                        type="button"
                      ...
                      .map(versionContext => (
                        ...
                        >
                          <VersionContextInfoRow
                            ...
                            isActive={
                              currentVersionContext === versionContext.name
                            }
                            onDisableValue={disableValue}
                          />
                        </ListboxOption>
...
const VersionContextInfoRow: React.FunctionComponent<{
  ...
  <>
    ...
    <span className="version-context-dropdown__option-description">
      {description}
    </span>
  </>
);
