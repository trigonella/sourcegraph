...
export class ApiConsole extends React.PureComponent<Props, State> {
  ...
  constructor(props: Props) {
    ...
    const parameters = JSON.parse(
      decodeURIComponent(props.location.hash.slice("#".length)) || "{}"
    ) as Parameters;
  ...
  private onEditQuery = (newQuery: string): void =>
    this.updateStateParameters(parameters => ({
      ...parameters,
      query: newQuery
    }));
  ...
  private updateStateParameters(
    update: (params: Parameters) => Parameters
  ): void {
    this.setState(
  ...
  private setGraphiQLRef = (
    reference: _graphiqlModule.default | null
  ): void => {
...
async function fetcher(
  graphQLParameters: _graphiqlModule.GraphQLParams
): Promise<string> {
