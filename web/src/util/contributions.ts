 ...
 */
export interface ComponentDescriptor<C extends object = {}>
 ...
 * @template C Context information that is passed to `render` and `condition`
 */
export interface RouteDescriptor<C extends object = {}, P = any>
  extends Conditional<C> {
 ...
 */
export interface NavItemDescriptor<C extends object = {}>
  extends Conditional<C> {
...
export interface NavItemWithIconDescriptor<C extends object = {}>
  extends NavItemDescriptor<C>,
    WithIcon {}
 ...
 */
export interface ActionButtonDescriptor<C extends object = {}>
  extends Conditional<C>,
    WithIcon {
