...
export interface UserSettingsAreaRoute
  extends RouteDescriptor<UserSettingsAreaRouteContext> {}
...
export const UserSettingsArea = withAuthenticatedUser(
  class UserSettingsArea extends React.Component<
    UserSettingsAreaProps,
    UserSettingsAreaState
  > {
    ...
    public render(): JSX.Element | null {
      ...
      if (
        ...
        !this.props.user.viewerCanAdminister
      ) {
        return (
          <HeroPage
            icon={MapSearchIcon}
