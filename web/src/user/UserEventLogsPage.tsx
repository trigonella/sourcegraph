...
export const UserEventNode: React.FunctionComponent<UserEventNodeProps> = ({
  node
}: UserEventNodeProps) => (
...
interface UserEventLogsPageProps
 ...
 */
export class UserEventLogsPage extends React.PureComponent<
  UserEventLogsPageProps
> {
  ...
  private queryUserEventLogs = (args: {
    first?: number;
  }): Observable<GQL.IEventLogsConnection> =>
    queryGraphQL(
      gql`
