  ...
  public componentDidMount(): void {
    this.subscriptions.add(
      fetchSiteUsageStatistics()
        ...
        .subscribe(siteUsageStatisticsOrError =>
          this.setState({ siteUsageStatisticsOrError })
        )
    );
  }
    ...
    return (
      <div className="site-usage-explore-section">
        ...
        {isErrorLike(this.state.siteUsageStatisticsOrError) ? (
          <ErrorAlert
            error={this.state.siteUsageStatisticsOrError}
          ...
          <div className="col-md-10 col-lg-8 mt-4">
            <BarChart
              ...
              data={this.state.siteUsageStatisticsOrError.waus
                .slice(0, 4)
                .map(usagePeriod => ({
                  xLabel: format(
                  ...
                  yValues: {
                    "Weekly users":
                      usagePeriod.registeredUserCount +
                      usagePeriod.anonymousUserCount
                  }
                }))}
            />
          </div>
