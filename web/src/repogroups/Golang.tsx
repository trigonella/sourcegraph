...
export const golang: RepogroupMetadata = {
  ...
  url: "/golang",
  description:
    "Use these search examples to explore Go repositories on GitHub.",
  examples: [
    {
      title:
        "Search for usages of the Retry-After header in non-vendor Go files",
      exampleQuery: (
        <>
          <span className="search-keyword">lang:</span>go{" "}
    ...
    },
    {
      ...
      exampleQuery: (
        <>
          {"if err != nil {:[_]}"} <span className="search-keyword">lang:</span>
          go
        </>
      ),
    ...
    },
    {
      ...
      exampleQuery: (
        <>
          <span className="search-keyword">lang:go</span> cmp.Diff(:[_], :[_],
          :[opts])
        </>
      ),
    ...
    },
    {
      ...
      exampleQuery: (
        <>
          ...
          <span className="search-keyword">-file:</span>vendor{" "}
          <span className="search-keyword">lang:</span>go
        </>
      ),
      rawQuery:
        "http.Transport{:[_], MaxIdleConns: :[idleconns], :[_]} -file:vendor lang:go",
      patternType: SearchPatternType.structural
    },
    {
