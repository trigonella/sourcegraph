...
export class SiteAdminTokensPage extends React.PureComponent<Props, State> {
  ...
  public render(): JSX.Element | null {
    ...
    return (
      <div className="user-settings-tokens-page">
        ...
        <div className="d-flex justify-content-between align-items-center mb-3">
          ...
          <LinkOrSpan
            ...
            className={`btn btn-primary ml-2 ${
              accessTokensEnabled ? "" : "disabled"
            }`}
            to={
              accessTokensEnabled
                ? `${this.props.authenticatedUser.settingsURL!}/tokens/new`
                : null
            }
          >
        ...
        <p>
          Tokens may be used to access the Sourcegraph API with the full
          privileges of the token's creator.
        </p>
        <FilteredConnection<
          GQL.IAccessToken,
          Omit<AccessTokenNodeProps, "node">
        >
  ...
  private queryAccessTokens = (args: {
    first?: number;
  }): Observable<GQL.IAccessTokenConnection> =>
    queryGraphQL(
      gql`
