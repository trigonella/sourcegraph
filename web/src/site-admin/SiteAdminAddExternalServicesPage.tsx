    ...
    <div className="add-external-services-page mt-3">
      ...
      {!hasDismissedPrivacyWarning && (
        <div className="alert alert-info">
          <p>
            This Sourcegraph installation will never send your code, repository
            names, file names, or any other specific code data to
            Sourcegraph.com or any other destination. Your code is kept private
