 ...
 */
export const Toggles: React.FunctionComponent<TogglesProps> = (
  props: TogglesProps
) => {
  const {
    history,
    ...
    (
      ...
      if (shouldSubmitSearch) {
        ...
        const newPatternType =
          "newPatternType" in args ? args.newPatternType : patternType;
        const newCaseSensitive =
          "newCaseSensitivity" in args
            ? args.newCaseSensitivity
            : caseSensitive;
        submitSearch({
          history,
