 ...
 * */
export const AddFilterRow: React.FunctionComponent<RowProps> = ({
  isHomepage,
  onAddNewFilter
}) => {
  const buildOnAddFilterHandler = (filterType: FilterType) => (
  ...
  return (
    <div
      className={`add-filter-row ${
        isHomepage ? "add-filter-row--homepage" : ""
      } test-add-filter-row`}
    >
