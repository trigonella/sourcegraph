...
const SearchExampleClicked = (url: string) => (): void =>
  eventLogger.log("ExampleSearchClicked", { url });
    ...
    <div className="web-content search-page">
      ...
      <div
        className={classNames("search-page__search-container", {
          "search-page__search-container--with-repogroups":
            props.isSourcegraphDotCom
        })}
      >
              ...
              <div className="col-xs-12 col-lg-5 col-xl-6">
                ...
                <ul className="list-group-flush p-0 mt-2">
                  ...
                  <li className="list-group-item px-0 pt-3 pb-2">
                    ...
                    <p className="mt-2">
                      Search for explicit imports with one or more leading dots
                      that indicate current and parent packages involved, across
                  ...
                  <li className="list-group-item px-0 pt-3 pb-2">
                    ...
                    >
                      ...
                      diff <span className="search-keyword">after:</span>"1 week
                      ago"
                    </Link>{" "}
                    <p className="mt-2">
