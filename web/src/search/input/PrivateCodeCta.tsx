  ...
  return (
    <div
      className={classNames(
        "web-content private-code-cta shadow d-flex flex-row card",
        props.className
      )}
    >
      ...
      <div>
        ...
        <p>
          Set up a private Sourcegraph instance to search your private
          repositories on GitHub, GitLab, Bitbucket and local installations of
          git, perforce, svn and other code repositories.
        </p>
        <Link
