...
> {
          ...
          if (inputValue !== "") {
            if (inputField === "patterns") {
              ...
              fieldsQueryParts.push(
                formatExactMatchField(inputValue, this.props.patternType)
              );
              ...
              fieldsQueryParts.push(
                formatFieldForQuery(inputField, inputValue)
              );
            }
          }
        }
  ...
  public render(): JSX.Element | null {
    const documentationUrlPrefix = this.props.isSourcegraphDotCom
      ...
      <div className="query-builder">
        ...
        <div className="query-builder__section query-builder__section--blue">
          <div className="query-builder__row">
            <label
              className="query-builder__row-label"
              htmlFor="query-builder__type"
            >
              Type:
            </label>
          ...
          {(this.state.typeOfSearch === "commit" ||
            ...
            <>
              <QueryBuilderInputRow
                ...
                examples={[
                  {
                    description: "Search for commits authored by alice",
                    value: "alice"
                  },
                  {
              ...
              <QueryBuilderInputRow
                ...
                examples={[
                  {
                    description:
                      'Search for commits whose message includes "fix: typo"',
                    value: "fix: typo"
                  },
                  {
                    description:
                      'Search for commits whose message includes "middleware"',
                    value: "middleware"
                  }
                ]}
              />
          ...
          <QueryBuilderInputRow
            ...
            examples={[
              ...
              {
                description:
                  "Search for lines that start with `package` and end with `test`",
                value: "^package test$"
              },
              {
                description:
        ...
        <div className="query-builder__section query-builder__section--purple">
          <QueryBuilderInputRow
            ...
            description={`Specify the repositories to search in. ${
              this.props.isSourcegraphDotCom
                ? ""
                : "By default, all repositories are searched."
            ...
            examples={[
              {
                description:
                  "Search in repositories named `gorilla/mux` or `gorilla/pat`",
                value: "gorilla/(mux|pat)$"
              },
              {
                description:
                  "Search in all repositories in a GitHub organization",
          ...
          <QueryBuilderInputRow
            ...
            examples={[
              {
                description:
                  "Search in files whose full path contains `internal`",
                value: "internal"
              },
              {
        ...
        <div className="query-builder__docs-link">
          ...
          >
            View all search options in docs{" "}
            <ExternalLinkIcon className="icon-inline small" />
          </a>
        </div>
      </div>
    );
 ...
 */
function formatExactMatchField(
  value: string,
