...
export const QueryBuilderInputRow: React.FunctionComponent<Props> = props => {
  const placeholder = props.isSourcegraphDotCom
    ? props.dotComPlaceholder || props.placeholder
    : props.placeholder;
  return (
    <div className="query-builder-input-row">
      <label
        className="query-builder-input-row__label"
        htmlFor={`query-builder__${props.shortName}`}
      >
        {props.title}:
      </label>
