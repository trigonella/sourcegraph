    ...
    useCallback(
      (
        creations: Observable<
          GQL.ICreatePaidProductSubscriptionOnDotcomMutationArguments
        >
      ) =>
        creations.pipe(
          switchMap(args =>
  ...
  return (
    <div className="user-subscriptions-new-product-subscription-page">
      ...
      <ProductSubscriptionForm
        ...
        subscriptionID={null}
        initialValue={
          parseProductSubscriptionInputFromLocation(location) || undefined
        }
 ...
 */
function parseProductSubscriptionInputFromLocation(
  location: H.Location
): GQL.IProductSubscriptionInput | null {
  if (location.hash) {
 ...
 */
export function productSubscriptionInputForLocationHash(
  value: GQL.IProductSubscriptionInput | null
): string {
  if (value === null) {
    return "";
  }
  ...
  return mutateGraphQL(
    ...
    map(({ data, errors }) => {
      if (
        !data ||
        !data.dotcom ||
        !data.dotcom.createPaidProductSubscription ||
