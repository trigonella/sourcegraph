  ...
  return (
    <div className="w-100">
      ...
      {user.siteAdmin ? (
        ...
        <div className="alert alert-info">
          This user is queued to sync permissions, it can only access
          non-private repositories until syncing is finished.
        </div>
      ) : (
        <div>
          ...
          <ScheduleUserPermissionsSyncActionContainer
            user={user}
            history={history}
          />
        </div>
