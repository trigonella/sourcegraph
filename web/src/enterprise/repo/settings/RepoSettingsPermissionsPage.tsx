    ...
    <div className="repo-settings-permissions-page w-100">
      ...
      {!repo.isPrivate ? (
        <div className="alert alert-info">
          Access to this repository is not restricted, all Sourcegraph users
          have access.
        </div>
      ) : !repo.permissionsInfo ? (
        <div className="alert alert-info">
          This repository is queued to sync permissions, only site admins will
          have access to it until syncing is finished.
        </div>
      ) : (
        <div>
            ...
            <tbody>
              <tr>
                ...
                <td className="text-muted">
                  Updated by repository permissions syncing
                </td>
              </tr>
              <tr>
                ...
                <td className="text-muted">
                  Updated by user permissions syncing
                </td>
              </tr>
            </tbody>
          </table>
          <ScheduleRepositoryPermissionsSyncActionContainer
            repo={repo}
            history={history}
          />
        </div>
...
> {
  public render(): JSX.Element | null {
    return (
      <ActionContainer
        ...
        description={
          <div>
            Site admins are able to manually schedule a permissions sync for
            this repository.
          </div>
        }
  ...
  private scheduleRepositoryPermissions = async (): Promise<void> => {
    await scheduleRepositoryPermissionsSync({
