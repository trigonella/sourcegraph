  ...
  public componentDidMount(): void {
    this.subscriptions.add(
      this.deletes
        .pipe(
          switchMap(() =>
            deleteRegistryExtensionWithConfirmation(
              ...
              startWith<
                Pick<RegistryExtensionDeleteButtonState, "deletionOrError">
              >({
    ...
    return (
      <div className="btn-group" role="group">
        <button
          ...
          disabled={
            this.props.disabled || this.state.deletionOrError === undefined
          }
          title={this.props.compact ? "Delete extension" : ""}
        >
          <DeleteIcon className="icon-inline" />{" "}
          {!this.props.compact && "Delete extension"}
        </button>
