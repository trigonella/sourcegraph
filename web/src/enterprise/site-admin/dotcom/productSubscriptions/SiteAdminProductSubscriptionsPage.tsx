 ...
 */
export const SiteAdminProductSubscriptionsPage: React.FunctionComponent<Props> = ({
  history,
  location
}) => {
  useEffect(
  ...
  return (
    <div className="site-admin-product-subscriptions-page">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <Link
          to="/site-admin/dotcom/product/subscriptions/new"
...
function queryProductSubscriptions(args: {
  ...
  return queryGraphQL(
    gql`
      query ProductSubscriptionsDotCom(
        $first: Int
        $account: ID
        $query: String
      ) {
