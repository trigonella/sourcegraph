 ...
 */
export const SiteAdminProductLicensesPage: React.FunctionComponent<Props> = ({
  history,
  location
}) => {
      ...
      <FilteredProductLicenseConnection
        ...
        emptyElement={
          <span className="text-muted mt-2">
            Enter a partial license key to find matches.
          </span>
        }
        ...
        gql`
          query DotComProductLicenses(
            ...
            dotcom {
              productLicenses(
                first: $first
                licenseKeySubstring: $licenseKeySubstring
              ) {
                nodes {
