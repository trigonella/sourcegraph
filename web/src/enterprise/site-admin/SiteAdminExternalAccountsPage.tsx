...
export class SiteAdminExternalAccountsPage extends React.Component<Props> {
    ...
    return (
      <div className="user-settings-external-accounts-page">
        ...
        <p>
          ...
          <Link to="/site-admin/auth/providers">authentication provider</Link>)
          is linked to a Sourcegraph user when it's used to sign into
          Sourcegraph.
        </p>
        <FilteredConnection<
          GQL.IExternalAccount,
          Omit<ExternalAccountNodeProps, "node">
        >
  ...
  private onDidUpdateExternalAccount = (): void =>
    this.externalAccountUpdates.next();
}
