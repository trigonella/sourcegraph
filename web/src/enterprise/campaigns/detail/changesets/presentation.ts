...
export const changesetExternalStateColorClasses: Record<
  ChangesetExternalState,
  string
> = {
...
export const changesetReviewStateColors: Record<
  ChangesetReviewState,
  string
> = {
...
export const changesetReviewStateIcons: Record<
  ChangesetReviewState,
...
export const changesetStateLabels: Record<
  ChangesetReviewState | ChangesetExternalState,
  string
> = {
...
export const changesetExternalStateIcons: Record<
  ChangesetExternalState,
  MdiReactIconComponentType
> = {
...
export const changesetCheckStateIcons: Record<
  ChangesetCheckState,
  MdiReactIconComponentType
> = {
...
export const changesetCheckStateTooltips: Record<
  ChangesetCheckState,
  string
> = {
