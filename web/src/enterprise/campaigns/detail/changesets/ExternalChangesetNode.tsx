...
export const ExternalChangesetNode: React.FunctionComponent<ExternalChangesetNodeProps> = ({
  ...
  const ReviewStateIcon =
    node.reviewState && changesetReviewStateIcons[node.reviewState];
        ...
        <div className="d-flex flex-column">
          <div className="m-0 mb-2">
            <h3 className="m-0 d-inline">
              <ChangesetStateIcon
                externalState={changesetState || ChangesetExternalState.OPEN}
              />
              <LinkOrSpan
  ...
  const [range, setRange] = useState<
    (NonNullable<ExternalChangesetFileDiffsFields["diff"]> & {
