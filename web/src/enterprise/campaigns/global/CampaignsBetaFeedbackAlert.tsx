...
export const CampaignsBetaFeedbackAlert: React.FunctionComponent<{
  partialStorageKey?: string;
}> = ({ partialStorageKey = "campaigns-beta" }) => (
  <DismissibleAlert
    partialStorageKey={partialStorageKey}
    className="alert-info"
  >
    <p className="mb-0">
      Campaigns are currently in beta. During the beta period, campaigns are
      free to use. After the beta period, campaigns will be available as a paid
      add-on. Get in touch on Twitter{" "}
