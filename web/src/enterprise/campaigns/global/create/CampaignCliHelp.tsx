      ...
      <div className="card-body p-3">
        <div className="alert alert-info mt-2">
          <a
            ...
            target="_blank"
          >
            Take a look at the documentation for more detailed steps and
        ...
        <div className="ml-2">
          ...
          <p>
            Make sure that <code>git</code> is installed and accessible by the
            src CLI.
          </p>
          <p>
            To create and manage access tokens, click your username in the top
            right to open the user menu, select <strong>Settings</strong>, and
            then <strong>Access tokens</strong>.
          </p>
        </div>
        <h3>2. Create an action definition</h3>
        <div className="ml-2 mb-1">
          <p>
            Here is a short example definition to run <code>gofmt</code> over
            all repositories that have a <code>main.go</code> file:
          </p>
          <pre className="alert alert-secondary ml-3">
            <code
              dangerouslySetInnerHTML={{
          ...
          <p>
            ...
            " in the documentation for more information about what actions can
            do.
          </p>
        </div>
        <h3>
        ...
        <div className="ml-2 mb-2">
            ...
            <code
              dangerouslySetInnerHTML={{
                __html: highlightCodeSafe(
                  "$ src action exec -f action.json -create-patchset",
                  "bash"
                )
              }}
            />
          ...
          <p>
            After executing the command, follow the printed instructions to
            create a campaign from the patches and turn the patches into
            changesets (pull requests) on your code hosts.
          </p>
          <p>
            Run <code>src action exec -h</code> to see more usage information
            about this command.
          </p>
        </div>
      </div>
