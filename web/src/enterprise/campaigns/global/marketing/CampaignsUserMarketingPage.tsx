  ...
  <CampaignsMarketing
    body={
      <section className="my-3">
        ...
        <p>
          At this time, creating and managing campaigns is only available to
          Sourcegraph admins. What can you do?
        </p>
        <div className="row">
          <ol>
            <li>
              Let your Sourcegraph admin know you're interested in using
            ...
            {enableReadAccess && (
              <li>
                ...
                <div className="alert alert-info mt-3">
                  <b>NOTE:</b> Repository permissions are NOT enforced by
                  campaigns, so your admin may not grant read-only access if
                  your Sourcegraph instance has repository permissions
                  configured.
                </div>
              </li>
            )}
