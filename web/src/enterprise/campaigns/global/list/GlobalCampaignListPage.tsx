    ...
    <>
      ...
      <div className="card mt-4 mb-4">
        <div className="card-body p-3">
          ...
          <p className="mb-1">
            We're excited for you to use campaigns to remove legacy code, fix
            critical security issues, pay down tech debt, and more. We look
            forward to hearing about campaigns you run inside your organization.
            Take a look at some{" "}
            <a href="https://docs.sourcegraph.com/user/campaigns/examples">
              examples in our documentation
            </a>
            , and{" "}
            <a href="mailto:feedback@sourcegraph.com?subject=Campaigns feedback">
              get in touch
            </a>{" "}
