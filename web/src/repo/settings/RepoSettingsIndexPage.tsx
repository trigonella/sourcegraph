 ...
 */
function fetchRepositoryTextSearchIndex(
  id: GQL.ID
): Observable<GQL.IRepositoryTextSearchIndex | null> {
  return queryGraphQL(
    gql`
      ...
      {indexedRef.indexed ? (
        <span>
          ...
          <code>
            <LinkOrSpan
              to={
                indexedRef.indexedCommit?.commit
        ...
        {!this.state.error &&
          ...
          (this.state.textSearchIndex ? (
                  ...
                  <table className="table repo-settings-index-page__stats">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <Timestamp
                            date={this.state.textSearchIndex.status.updatedAt}
                          />
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          {prettyBytes(
                            this.state.textSearchIndex.status.contentByteSize
                          )}{" "}
                      ...
                      <tr>
                        ...
                        <td>
                          {prettyBytes(
                            this.state.textSearchIndex.status.indexByteSize
                          )}{" "}
            ...
            <div className="alert alert-info">
              ...
              <Link to="/help/admin/search">search documentation</Link> for
