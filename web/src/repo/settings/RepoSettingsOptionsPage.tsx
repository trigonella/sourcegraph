      ...
      <div className="repo-settings-options-page">
        ...
        {services.length > 0 && (
          <div className="mb-4">
            ...
            {services.length > 1 && (
              <p>
                This repository is mirrored by multiple external services. To
                change access, disable, or remove this repository, the
                configuration must be updated on all external services.
              </p>
            )}
          </div>
        )}
        <Form>
          <div className="form-group">
            <label htmlFor="repo-settings-options-page__name">
              Repository name
            </label>
            <input
