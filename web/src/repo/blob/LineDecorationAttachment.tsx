...
export class LineDecorationAttachment extends React.PureComponent<
  LineDecorationAttachmentProps
> {
  ...
  public UNSAFE_componentWillReceiveProps(
    nextProps: Readonly<LineDecorationAttachmentProps>
  ): void {
    if (
  ...
  public render(): React.ReactPortal | null {
    ...
    return ReactDOM.createPortal(
      <LinkOrSpan
        ...
        target={
          this.props.attachment.linkURL &&
          isAbsoluteUrl(this.props.attachment.linkURL)
            ? "_blank"
            : undefined
        }
