...
} from "./RepositoryGitDataContainer";
...
export interface RepoRevisionContainerContext
  extends RepoHeaderContributionsLifecycleProps,
    ...
    Pick<
      ...
      Exclude<
        keyof RepoContainerContext,
        "onDidUpdateRepository" | "onDidUpdateExternalLinks"
      >
    >,
    PatternTypeProps,
    CaseSensitivityProps,
...
export interface RepoRevisionContainerRoute
  extends RouteDescriptor<RepoRevisionContainerContext> {}
...
interface RepoRevisionContainerProps
  ...
  onResolvedRevisionOrError: (
    v: ResolvedRevision | ErrorLike | undefined
  ) => void;
  history: H.History;
 ...
 */
export class RepoRevisionContainer extends React.PureComponent<
  RepoRevisionContainerProps,
  RepoRevisionContainerState
> {
  ...
  public render(): JSX.Element | null {
    ...
    if (isErrorLike(this.props.resolvedRevisionOrError)) {
      ...
      if (isCloneInProgressErrorLike(this.props.resolvedRevisionOrError)) {
        return (
          <RepositoryCloningInProgressPage
            ...
            progress={
              (this.props.resolvedRevisionOrError as CloneInProgressError)
                .progress
            }
          />
        );
      ...
      return (
        <HeroPage
          ...
          subtitle={
            <ErrorMessage
              error={this.props.resolvedRevisionOrError}
    ...
    const context: RepoRevisionContainerContext = {
      ...
      repoHeaderContributionsLifecycleProps: this.props
        .repoHeaderContributionsLifecycleProps,
    ...
    return (
      <div className="repo-revision-container">
          ...
          element={
            <div className="d-flex align-items-center" key="repo-revision">
              <span className="test-revision">
                {(this.props.revision &&
                this.props.revision ===
                  this.props.resolvedRevisionOrError.commitID
        ...
        <RepoHeaderContributionPortal
          position="left"
          element={
            <CopyLinkAction key="copy-link" location={this.props.location} />
          }
          repoHeaderContributionsLifecycleProps={
            this.props.repoHeaderContributionsLifecycleProps
          }
