...
export const RepositoryCloningInProgressPage: React.FunctionComponent<{
  repoName: string;
  progress?: string;
}> = ({ repoName, progress }) => (
  <HeroPage
 ...
 * rendered.
 */
export class RepositoryGitDataContainer extends React.PureComponent<
  Props,
  State
> {
  public state: State = {};
    ...
    if (isErrorLike(this.state.gitDataPresentOrError)) {
      ...
      if (isCloneInProgressErrorLike(this.state.gitDataPresentOrError)) {
        return (
          <RepositoryCloningInProgressPage
            ...
            progress={
              (this.state.gitDataPresentOrError as CloneInProgressError)
                .progress
            }
          />
        );
      ...
      return (
        <HeroPage
          ...
          subtitle={
            <ErrorMessage
              error={this.state.gitDataPresentOrError}
