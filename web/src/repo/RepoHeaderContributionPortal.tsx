...
interface Props
  extends RepoHeaderContribution,
    RepoHeaderContributionsLifecycleProps {}
...
export class RepoHeaderContributionPortal extends React.Component<Props> {
  ...
  public shouldComponentUpdate(nextProps: Props): boolean {
    ...
    return (
      this.props.repoHeaderContributionsLifecycleProps !==
        nextProps.repoHeaderContributionsLifecycleProps ||
  ...
  public componentWillUnmount(): void {
    ...
    if (this.props.repoHeaderContributionsLifecycleProps) {
      ...
      this.props.repoHeaderContributionsLifecycleProps.onRepoHeaderContributionRemove(
        key
      );
    }
  }
  ...
  private addOrUpdateContribution(): void {
    if (this.props.repoHeaderContributionsLifecycleProps) {
      this.props.repoHeaderContributionsLifecycleProps.onRepoHeaderContributionAdd(
        this.props
      );
    }
  }
