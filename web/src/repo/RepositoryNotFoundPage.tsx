      ...
      this.componentUpdates
        .pipe(
          distinctUntilChanged(
            (a, b) =>
              a.repo === b.repo &&
              a.viewerCanAdminister === b.viewerCanAdminister
          ),
          switchMap(({ repo, viewerCanAdminister }) => {
            ...
            return merge<PartialStateUpdate>(
              ...
              checkMirrorRepositoryConnection({ name: repo }).pipe(
                ...
                map(
                  (canAddOrError): PartialStateUpdate => ({
                    showAdd: true,
                    canAddOrError
                  })
                )
                ...
                <div className="repository-not-found-page__section-inner">
                  <div className="repository-not-found-page__section-description">
                    ...
                    {(this.state.canAddOrError === false ||
                      ...
                      <>
                        <p>
                          If this is a private repository, check that this site
                          is configured with a token that has access to this
                          repository.
                        </p>

                        <p>
                          If this is a public repository, check that this
                          repository is explicitly listed in an{" "}
                    ...
                    {this.state.canAddOrError === true && (
                      <>
                        As a site admin, you can add this repository to
                        Sourcegraph to allow users to search and view it by{" "}
                        <a href="/site-admin/external-services">
