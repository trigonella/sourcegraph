...
export const PasswordInput: React.FunctionComponent<React.InputHTMLAttributes<
  HTMLInputElement
> & {
  ...
  return (
    <input
      ...
      type="password"
      placeholder={
        props.placeholder === undefined ? "Password" : props.placeholder
      }
      required={true}
      ref={inputRef}
    />
...
export const EmailInput: React.FunctionComponent<React.InputHTMLAttributes<
  HTMLInputElement
>> = props => (
  <input
    name="email"
...
export const UsernameInput: React.FunctionComponent<React.InputHTMLAttributes<
  HTMLInputElement
>> = props => (
  <input
    name="username"
