...
export class FileDiffHunks extends React.Component<
  FileHunksProps,
  FileDiffHunksState
> {
  /** Emits whenever the ref callback for the code element is called */
  private codeElements = new Subject<HTMLElement | null>();
  private nextCodeElement = (element: HTMLElement | null): void =>
    this.codeElements.next(element);
        ...
        this.props.extensionInfo.hoverifier.hoverify({
          ...
          resolveContext: hoveredToken => {
            ...
            const {
              ...
              filePath,
              commitID
            } = this.props.extensionInfo![hoveredToken.part || "head"];
        ...
        .pipe(
          ...
          switchMap(({ head, base, extensionsController }) => {
            ...
            return combineLatest([
              getDecorationsForPart(head),
              getDecorationsForPart(base)
            ]);
          })
        )
  ...
  public render(): JSX.Element | null {
    return (
      <div
        className={`file-diff-hunks ${this.props.className}`}
