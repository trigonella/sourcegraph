...
export const SIDEBAR_LIST_GROUP_ITEM_ACTION_CLASS =
...
export const SidebarNavItem: React.FunctionComponent<{
  ...
  exact?: boolean;
  className?: string;
}> = ({ children, to, exact, className = "" }) => (
  <NavLink
    to={to}
    exact={exact}
    className={`${SIDEBAR_LIST_GROUP_ITEM_ACTION_CLASS} ${className}`}
  >
    {children}
  </NavLink>
);
 ...
 */
export const SidebarGroupItems: React.FunctionComponent<{}> = ({
  children
