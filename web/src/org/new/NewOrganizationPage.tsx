...
export class NewOrganizationPage extends React.Component<Props, State> {
      ...
      <div className="new-org-page">
        ...
        <Form className="settings-form" onSubmit={this.onSubmit}>
          ...
          <p>
            ...
            <Link to="/help/user/organizations">Sourcegraph documentation</Link>{" "}
          ...
          <div className="form-group">
            ...
            />
            <small
              id="new-org-page__form-name-help"
              className="form-text text-muted"
            >
              An organization name consists of letters, numbers, hyphens (-),
              dots (.) and may not begin or end with a dot, nor begin with a
              hyphen.
            </small>
          </div>

          <div className="form-group">
            <label htmlFor="new-org-page__form-display-name">
              Display name
            </label>
            <input
  ...
  private onDisplayNameChange: React.ChangeEventHandler<
    HTMLInputElement
  > = event => {
