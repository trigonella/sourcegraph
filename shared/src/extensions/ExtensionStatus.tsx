  ...
  public componentDidMount(): void {
    ...
    this.subscriptions.add(
      extensionsController
        .pipe(
          switchMap(
            extensionsController =>
              extensionsController.services.extensions.activeExtensions
          ),
    ...
    this.subscriptions.add(
      platformContext
        ...
        .subscribe(sideloadedExtensionURL =>
          this.setState({ sideloadedExtensionURL })
        )
    );
        ...
        <div className="card-body border-top">
          ...
          {this.state.sideloadedExtensionURL ? (
            <div>
              <p>
                <span>Load from: </span>
                <Link to={this.state.sideloadedExtensionURL}>
                  {this.state.sideloadedExtensionURL}
                </Link>
              </p>
              <div>
