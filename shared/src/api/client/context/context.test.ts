...
describe("getComputedContextProperty", () => {
  test("provides config", () => {
    ...
    expect(
      getComputedContextProperty(undefined, settings, {}, "config.a")
    ).toBe(1);
    expect(
      getComputedContextProperty(undefined, settings, {}, "config.a.b")
    ).toBe(2);
    expect(
      getComputedContextProperty(undefined, settings, {}, "config.c.d")
    ).toBe(3);
    expect(
      getComputedContextProperty(undefined, settings, {}, "config.x")
    ).toBe(null);
  });
  ...
  describe("with code editors", () => {
    ...
    describe("component", () => {
      ...
      function assertSelection(
        ...
        ).toBe(expected.start.line);
        expect(
          getComputedContextProperty(
            editor,
            EMPTY_SETTINGS_CASCADE,
            {},
            `${expression}.start.character`
          )
        ...
        ).toBe(expected.end.line);
        expect(
          getComputedContextProperty(
            editor,
            EMPTY_SETTINGS_CASCADE,
            {},
            `${expression}.end.character`
          )
      ...
      function assertNoSelection(editor?: CodeEditorWithPartialModel): void {
        ...
        expect(
          getComputedContextProperty(
            ...
            EMPTY_SETTINGS_CASCADE,
            {},
            "component.selection.start.line"
          )
        ).toBe(null);
        expect(
          getComputedContextProperty(
  ...
  test("falls back to the context entries", () => {
    ...
    expect(
      getComputedContextProperty(undefined, EMPTY_SETTINGS_CASCADE, {}, "y")
    ).toBe(undefined);
  });
});
