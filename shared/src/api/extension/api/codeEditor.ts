...
const isDecorationEmpty = ({
  ...
  isWholeLine,
  ...contents
}: clientType.TextDocumentDecoration): boolean => isEmptyObjectDeep(contents);
...
export class ExtensionCodeEditor implements sourcegraph.CodeEditor {
  ...
  public readonly selectionsChanges = new BehaviorSubject<
  ...
  public setDecorations(
    ...
    this.proxy.$setDecorations(
      ...
      decorationType.key,
      decorations
        .map(fromTextDocumentDecoration)
