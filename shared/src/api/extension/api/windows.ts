...
export class ExtensionWindow implements sourcegraph.Window {
  ...
  private viewComponents = new Map<
    string,
    ExtensionCodeEditor | sourcegraph.DirectoryViewer
  >();

  constructor(
    private proxy: Remote<WindowsProxyData>,
  ...
  public readonly activeViewComponentChanges = new BehaviorSubject<
    sourcegraph.ViewComponent | undefined
  >(undefined);
  ...
  public showInputBox(
    options?: sourcegraph.InputBoxOptions
