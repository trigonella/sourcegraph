...
export const HIGHLIGHTED_FILE_LINES_REQUEST = sinon.fake.returns(
  of(HIGHLIGHTED_FILE_LINES)
);
export const HIGHLIGHTED_FILE_LINES_SIMPLE_REQUEST = sinon.fake.returns(
  of(HIGHLIGHTED_FILE_LINES_SIMPLE)
);
...
export const extensionsController: Pick<
  Controller,
  "executeCommand" | "services" | "extHostAPI"
> = {
