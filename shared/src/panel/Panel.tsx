...
} from "../api/client/services/panelViews";
import {
  ContributableMenu,
  ContributableViewContainer
} from "../api/protocol/contribution";
...
interface State {
  ...
  panelViews?:
    | (PanelViewWithComponent &
        Pick<PanelViewProviderRegistrationOptions, "id">)[]
    | null;
}
...
export class Panel extends React.PureComponent<Props, State> {
  ...
  public render(): JSX.Element | null {
    ...
    const activePanelViewID = TabsWithURLViewStatePersistence.readFromURL(
      this.props.location,
      items
    );
  ...
  private onDismiss = (): void =>
    this.props.history.push(
      TabsWithURLViewStatePersistence.urlForTabID(this.props.location, null)
    );
}
