...
export class ResultContainer extends React.PureComponent<Props, State> {
  constructor(props: Props) {
    super(props);
    this.state = {
      expanded: this.props.allExpanded || this.props.defaultExpanded
    };
  }
  ...
  public render(): JSX.Element | null {
    ...
    const stringIcon = this.props.stringIcon
      ? this.props.stringIcon
      : undefined;
    return (
      <div
        ...
        <div
          className={
            ...
            (this.props.collapsible
              ? " result-container__header--collapsible"
              : "")
          }
          onClick={this.toggle}
        >
          {stringIcon ? (
            <img
              src={stringIcon}
              className="icon-inline icon-inline__filtered"
            />
          ) : (
            <Icon className="icon-inline" />
          )}
          <div
            className={`result-container__header-title ${this.props
              .titleClassName || ""}`}
